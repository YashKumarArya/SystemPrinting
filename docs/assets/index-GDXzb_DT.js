...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ss(){return new va({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(){return new va({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ws(),fragmentShader:`
	...
	`}var Ts=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ia([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function pd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}function md(e){if(e===void 0)throw ReferenceError(`this hasn't been initialised - super() hasn't been called`);return e}function hd(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}var gd={autoSleep:120,force3D:`auto`,nullTargetWarn:1,units:{lineHeight:``}},_d={duration:.5,overwrite:!1,delay:0},vd,yd,bd,xd=1e8,Sd=1/xd,Cd=Math.PI*2,wd=Cd/4,Td=0,Ed=Math.sqrt,Dd=Math.cos,Od=Math.sin,kd=function(e){return typeof e==`string`},Ad=function(e){return typeof e==`function`},jd=function(e){return typeof e==`number`},Md=function(e){return e===void 0},Nd=function(e){return typeof e==`object`},Pd=function(e){return e!==!1},Fd=function(){return typeof window<`u`},Id=function(e){return Ad(e)||kd(e)},Ld=typeof ArrayBuffer==`function`&&ArrayBuffer.isView||function(){},Rd=Array.isArray,zd=/random\([^)]+\)/g,Bd=/,\s*/g,Vd=/(?:-?\.?\d|\.)+/gi,Hd=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Ud=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Wd=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Gd=/[+-]=-?[.\d]+/,Kd=/[^,'"\[\]\s]+/gi,qd=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Jd,Yd,Xd,Zd,Qd={},$d={},ef,tf=function(e){return($d=Pf(e,Qd))&&$m},nf=function(e,t){return console.warn(`Invalid property`,e,`set to`,t,`Missing plugin? gsap.registerPlugin()`)},rf=function(e,t){return!t&&console.warn(e)},af=function(e,t){return e&&(Qd[e]=t)&&$d&&($d[e]=t)||Qd},of=function(){return 0},sf={suppressEvents:!0,isStart:!0,kill:!1},cf={suppressEvents:!0,kill:!1},lf={suppressEvents:!0},uf={},df=[],ff={},pf,mf={},hf={},gf=30,_f=[],vf=``,yf=function(e){var t=e[0],n,r;if(Nd(t)||Ad(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=_f.length;r--&&!_f[r].targetTest(t););n=_f[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new lm(e[r],n)))||e.splice(r,1);return e},bf=function(e){return e._gsap||yf(_p(e))[0]._gsap},xf=function(e,t,n){return(n=e[t])&&Ad(n)?e[t]():Md(n)&&e.getAttribute&&e.getAttribute(t)||n},Sf=function(e,t){return(e=e.split(`,`)).forEach(t)||e},Cf=function(e){return Math.round(e*1e5)/1e5||0},wf=function(e){return Math.round(e*1e7)/1e7||0},Tf=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n===`+`?e+r:n===`-`?e-r:n===`*`?e*r:e/r},Ef=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},Df=function(){var e=df.length,t=df.slice(0),n,r;for(ff={},df.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},Of=function(e){return!!(e._initted||e._startAt||e.add)},kf=function(e,t,n,r){df.length&&!yd&&Df(),e.render(t,n,r||!!(yd&&t<0&&Of(e))),df.length&&!yd&&Df()},Af=function(e){var t=parseFloat(e);return(t||t===0)&&(e+``).match(Kd).length<2?t:kd(e)?e.trim():e},jf=function(e){return e},Mf=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},Nf=function(e){return function(t,n){for(var r in n)r in t||r===`duration`&&e||r===`ease`||(t[r]=n[r])}},Pf=function(e,t){for(var n in t)e[n]=t[n];return e},Ff=function e(t,n){for(var r in n)r!==`__proto__`&&r!==`constructor`&&r!==`prototype`&&(t[r]=Nd(n[r])?e(t[r]||(t[r]={}),n[r]):n[r]);return t},If=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},Lf=function(e){var t=e.parent||Jd,n=e.keyframes?Nf(Rd(e.keyframes)):Mf;if(Pd(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},Rf=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},zf=function(e,t,n,r,i){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var a=e[r],o;if(i)for(o=t[i];a&&a[i]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=a,t.parent=t._dp=e,t},Bf=function(e,t,n,r){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var i=t._prev,a=t._next;i?i._next=a:e[n]===t&&(e[n]=a),a?a._prev=i:e[r]===t&&(e[r]=i),t._next=t._prev=t.parent=null},Vf=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Hf=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},Uf=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Wf=function(e,t,n,r){return e._startAt&&(yd?e._startAt.revert(cf):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},Gf=function e(t){return!t||t._ts&&e(t.parent)},Kf=function(e){return e._repeat?qf(e._tTime,e=e.duration()+e._rDelay)*e:0},qf=function(e,t){var n=Math.floor(e=wf(e/t));return e&&n===e?n-1:n},Jf=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Yf=function(e){return e._end=wf(e._start+(e._tDur/Math.abs(e._ts||e._rts||Sd)||0))},Xf=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=wf(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Yf(e),n._dirty||Hf(n,e)),e},Zf=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Jf(e.rawTime(),t),(!t._dur||dp(0,t.totalDuration(),n)-t._tTime>Sd)&&t.render(n,!0)),Hf(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-Sd}},Qf=function(e,t,n,r){return t.parent&&Vf(t),t._start=wf((jd(n)?n:n||e!==Jd?cp(e,n,t):e._time)+t._delay),t._end=wf(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),zf(e,t,`_first`,`_last`,e._sort?`_start`:0),np(t)||(e._recent=t),r||Zf(e,t),e._ts<0&&Xf(e,e._tTime),e},$f=function(e,t){return(Qd.ScrollTrigger||nf(`scrollTrigger`,t))&&Qd.ScrollTrigger.create(t,e)},ep=function(e,t,n,r,i){if(vm(e,t,i),!e._initted)return 1;if(!n&&e._pt&&!yd&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&pf!==Yp.frame)return df.push(e),e._lazy=[i,r],1},tp=function e(t){var n=t.parent;return n&&n._ts&&n._initted&&!n._lock&&(n.rawTime()<0||e(n))},np=function(e){var t=e.data;return t===`isFromStart`||t===`isStart`},rp=function(e,t,n,r){var i=e.ratio,a=t<0||!t&&(!e._start&&tp(e)&&!(!e._initted&&np(e))||(e._ts<0||e._dp._ts<0)&&!np(e))?0:1,o=e._rDelay,s=0,c,l,u;if(o&&e._repeat&&(s=dp(0,e._tDur,t),l=qf(s,o),e._yoyo&&l&1&&(a=1-a),l!==qf(e._tTime,o)&&(i=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==i||yd||r||e._zTime===Sd||!t&&e._zTime){if(!e._initted&&ep(e,t,r,n,s))return;for(u=e._zTime,e._zTime=t||(n?Sd:0),n||=t&&!u,e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=s,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Wf(e,t,n,!0),e._onUpdate&&!n&&Pp(e,`onUpdate`),s&&e._repeat&&!n&&e.parent&&Pp(e,`onRepeat`),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&Vf(e,1),!n&&!yd&&(Pp(e,a?`onComplete`:`onReverseComplete`,!0),e._prom&&e._prom()))}else e._zTime||=t},ip=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data===`isPause`&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data===`isPause`&&r._start<t)return r;r=r._prev}},ap=function(e,t,n,r){var i=e._repeat,a=wf(t)||0,o=e._tTime/e._tDur;return o&&!r&&(e._time*=a/e._dur),e._dur=a,e._tDur=i?i<0?1e10:wf(a*(i+1)+e._rDelay*i):a,o>0&&!r&&Xf(e,e._tTime=e._tDur*o),e.parent&&Yf(e),n||Hf(e.parent,e),e},op=function(e){return e instanceof dm?Hf(e):ap(e,e._dur)},sp={_start:0,endTime:of,totalDuration:of},cp=function e(t,n,r){var i=t.labels,a=t._recent||sp,o=t.duration()>=xd?a.endTime(!1):t._dur,s,c,l;return kd(n)&&(isNaN(n)||n in i)?(c=n.charAt(0),l=n.substr(-1)===`%`,s=n.indexOf(`=`),c===`<`||c===`>`?(s>=0&&(n=n.replace(/=/,``)),(c===`<`?a._start:a.endTime(a._repeat>=0))+(parseFloat(n.substr(1))||0)*(l?(s<0?a:r).totalDuration()/100:1)):s<0?(n in i||(i[n]=o),i[n]):(c=parseFloat(n.charAt(s-1)+n.substr(s+1)),l&&r&&(c=c/100*(Rd(r)?r[0]:r).totalDuration()),s>1?e(t,n.substr(0,s-1),r)+c:o+c)):n==null?o:+n},lp=function(e,t,n){var r=jd(t[1]),i=(r?2:1)+(e<2?0:1),a=t[i],o,s;if(r&&(a.duration=t[1]),a.parent=n,e){for(o=a,s=n;s&&!(`immediateRender`in o);)o=s.vars.defaults||{},s=Pd(s.vars.inherit)&&s.parent;a.immediateRender=Pd(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[i-1]}return new Tm(t[0],a,t[i+1])},up=function(e,t){return e||e===0?t(e):t},dp=function(e,t,n){return n<e?e:n>t?t:n},fp=function(e,t){return!kd(e)||!(t=qd.exec(e))?``:t[1]},pp=function(e,t,n){return up(n,function(n){return dp(e,t,n)})},mp=[].slice,hp=function(e,t){return e&&Nd(e)&&`length`in e&&(!t&&!e.length||e.length-1 in e&&Nd(e[0]))&&!e.nodeType&&e!==Yd},gp=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(e){var r;return kd(e)&&!t||hp(e,1)?(r=n).push.apply(r,_p(e)):n.push(e)})||n},_p=function(e,t,n){return bd&&!t&&bd.selector?bd.selector(e):kd(e)&&!n&&(Xd||!Xp())?mp.call((t||Zd).querySelectorAll(e),0):Rd(e)?gp(e,n):hp(e)?mp.call(e,0):e?[e]:[]},vp=function(e){return e=_p(e)[0]||rf(`Invalid scope`)||{},function(t){var n=e.current||e.nativeElement||e;return _p(t,n.querySelectorAll?n:n===e?rf(`Invalid scope`)||Zd.createElement(`div`):e)}},yp=function(e){return e.sort(function(){return .5-Math.random()})},bp=function(e){if(Ad(e))return e;var t=Nd(e)?e:{each:e},n=im(t.ease),r=t.from||0,i=parseFloat(t.base)||0,a={},o=r>0&&r<1,s=isNaN(r)||o,c=t.axis,l=r,u=r;return kd(r)?l=u={center:.5,edges:.5,end:1}[r]||0:!o&&s&&(l=r[0],u=r[1]),function(e,o,d){var f=(d||t).length,p=a[f],m,h,g,_,v,y,b,x,S;if(!p){if(S=t.grid===`auto`?0:(t.grid||[1,xd])[1],!S){for(b=-xd;b<(b=d[S++].getBoundingClientRect().left)&&S<f;);S<f&&S--}for(p=a[f]=[],m=s?Math.min(S,f)*l-.5:r%S,h=S===xd?0:s?f*u/S-.5:r/S|0,b=0,x=xd,y=0;y<f;y++)g=y%S-m,_=h-(y/S|0),p[y]=v=c?Math.abs(c===`y`?_:g):Ed(g*g+_*_),v>b&&(b=v),v<x&&(x=v);r===`random`&&yp(p),p.max=b-x,p.min=x,p.v=f=(parseFloat(t.amount)||parseFloat(t.each)*(S>f?f-1:c?c===`y`?f/S:S:Math.max(S,f/S))||0)*(r===`edges`?-1:1),p.b=f<0?i-f:i,p.u=fp(t.amount||t.each)||0,n=n&&f<0?nm(n):n}return f=(p[e]-p.min)/p.max||0,wf(p.b+(n?n(f):f)*p.v)+p.u}},xp=function(e){var t=10**((e+``).split(`.`)[1]||``).length;return function(n){var r=wf(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+(jd(n)?0:fp(n))}},Sp=function(e,t){var n=Rd(e),r,i;return!n&&Nd(e)&&(r=n=e.radius||xd,e.values?(e=_p(e.values),(i=!jd(e[0]))&&(r*=r)):e=xp(e.increment)),up(t,n?Ad(e)?function(t){return i=e(t),Math.abs(i-t)<=r?i:t}:function(t){for(var n=parseFloat(i?t.x:t),a=parseFloat(i?t.y:0),o=xd,s=0,c=e.length,l,u;c--;)i?(l=e[c].x-n,u=e[c].y-a,l=l*l+u*u):l=Math.abs(e[c]-n),l<o&&(o=l,s=c);return s=!r||o<=r?e[s]:t,i||s===t||jd(t)?s:s+fp(t)}:xp(e))},Cp=function(e,t,n,r){return up(Rd(e)?!t:n===!0?!!(n=0):!r,function(){return Rd(e)?e[~~(Math.random()*e.length)]:(n||=1e-5)&&(r=n<1?10**((n+``).length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},wp=function(){var e=[...arguments];return function(t){return e.reduce(function(e,t){return t(e)},t)}},Tp=function(e,t){return function(n){return e(parseFloat(n))+(t||fp(n))}},Ep=function(e,t,n){return jp(e,t,0,1,n)},Dp=function(e,t,n){return up(n,function(n){return e[~~t(n)]})},Op=function e(t,n,r){var i=n-t;return Rd(t)?Dp(t,e(0,t.length),n):up(r,function(e){return(i+(e-t)%i)%i+t})},kp=function e(t,n,r){var i=n-t,a=i*2;return Rd(t)?Dp(t,e(0,t.length-1),n):up(r,function(e){return e=(a+(e-t)%a)%a||0,t+(e>i?a-e:e)})},Ap=function(e){return e.replace(zd,function(e){var t=e.indexOf(`[`)+1,n=e.substring(t||7,t?e.indexOf(`]`):e.length-1).split(Bd);return Cp(t?n:+n[0],t?0:+n[1],+n[2]||1e-5)})},jp=function(e,t,n,r,i){var a=t-e,o=r-n;return up(i,function(t){return n+((t-e)/a*o||0)})},Mp=function e(t,n,r,i){var a=isNaN(t+n)?0:function(e){return(1-e)*t+e*n};if(!a){var o=kd(t),s={},c,l,u,d,f;if(r===!0&&(i=1)&&(r=null),o)t={p:t},n={p:n};else if(Rd(t)&&!Rd(n)){for(u=[],d=t.length,f=d-2,l=1;l<d;l++)u.push(e(t[l-1],t[l]));d--,a=function(e){e*=d;var t=Math.min(f,~~e);return u[t](e-t)},r=n}else i||(t=Pf(Rd(t)?[]:{},t));if(!u){for(c in n)pm.call(s,t,c,`get`,n[c]);a=function(e){return Pm(e,s)||(o?t.p:t)}}}return up(r,a)},Np=function(e,t,n){var r=e.labels,i=xd,a,o,s;for(a in r)o=r[a]-t,o<0==!!n&&o&&i>(o=Math.abs(o))&&(s=a,i=o);return s},Pp=function(e,t,n){var r=e.vars,i=r[t],a=bd,o=e._ctx,s,c,l;if(i)return s=r[t+`Params`],c=r.callbackScope||e,n&&df.length&&Df(),o&&(bd=o),l=s?i.apply(c,s):i.call(c),bd=a,l},Fp=function(e){return Vf(e),e.scrollTrigger&&e.scrollTrigger.kill(!!yd),e.progress()<1&&Pp(e,`onInterrupt`),e},Ip,Lp=[],Rp=function(e){if(e)if(e=!e.name&&e.default||e,Fd()||e.headless){var t=e.name,n=Ad(e),r=t&&!n&&e.init?function(){this._props=[]}:e,i={init:of,render:Pm,add:pm,kill:Im,modifier:Fm,rawVars:0},a={targetTest:0,get:0,getSetter:Am,aliases:{},register:0};if(Xp(),e!==r){if(mf[t])return;Mf(r,Mf(If(e,i),a)),Pf(r.prototype,Pf(i,If(e,a))),mf[r.prop=t]=r,e.targetTest&&(_f.push(r),uf[t]=1),t=(t===`css`?`CSS`:t.charAt(0).toUpperCase()+t.substr(1))+`Plugin`}af(t,r),e.register&&e.register($m,r,zm)}else Lp.push(e)},zp=255,Bp={aqua:[0,zp,zp],lime:[0,zp,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,zp],navy:[0,0,128],white:[zp,zp,zp],olive:[128,128,0],yellow:[zp,zp,0],orange:[zp,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[zp,0,0],pink:[zp,192,203],cyan:[0,zp,zp],transparent:[zp,zp,zp,0]},Vp=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*zp+.5|0},Hp=function(e,t,n){var r=e?jd(e)?[e>>16,e>>8&zp,e&zp]:0:Bp.black,i,a,o,s,c,l,u,d,f,p;if(!r){if(e.substr(-1)===`,`&&(e=e.substr(0,e.length-1)),Bp[e])r=Bp[e];else if(e.charAt(0)===`#`){if(e.length<6&&(i=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e=`#`+i+i+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):``)),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&zp,r&zp,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&zp,e&zp]}else if(e.substr(0,3)===`hsl`){if(r=p=e.match(Vd),!t)s=r[0]%360/360,c=r[1]/100,l=r[2]/100,a=l<=.5?l*(c+1):l+c-l*c,i=l*2-a,r.length>3&&(r[3]*=1),r[0]=Vp(s+1/3,i,a),r[1]=Vp(s,i,a),r[2]=Vp(s-1/3,i,a);else if(~e.indexOf(`=`))return r=e.match(Hd),n&&r.length<4&&(r[3]=1),r}else r=e.match(Vd)||Bp.transparent;r=r.map(Number)}return t&&!p&&(i=r[0]/zp,a=r[1]/zp,o=r[2]/zp,u=Math.max(i,a,o),d=Math.min(i,a,o),l=(u+d)/2,u===d?s=c=0:(f=u-d,c=l>.5?f/(2-u-d):f/(u+d),s=u===i?(a-o)/f+(a<o?6:0):u===a?(o-i)/f+2:(i-a)/f+4,s*=60),r[0]=~~(s+.5),r[1]=~~(c*100+.5),r[2]=~~(l*100+.5)),n&&r.length<4&&(r[3]=1),r},Up=function(e){var t=[],n=[],r=-1;return e.split(Gp).forEach(function(e){var i=e.match(Ud)||[];t.push.apply(t,i),n.push(r+=i.length+1)}),t.c=n,t},Wp=function(e,t,n){var r=``,i=(e+r).match(Gp),a=t?`hsla(`:`rgba(`,o=0,s,c,l,u;if(!i)return e;if(i=i.map(function(e){return(e=Hp(e,t,1))&&a+(t?e[0]+`,`+e[1]+`%,`+e[2]+`%,`+e[3]:e.join(`,`))+`)`}),n&&(l=Up(e),s=n.c,s.join(r)!==l.c.join(r)))for(c=e.replace(Gp,`1`).split(Ud),u=c.length-1;o<u;o++)r+=c[o]+(~s.indexOf(o)?i.shift()||a+`0,0,0,0)`:(l.length?l:i.length?i:n).shift());if(!c)for(c=e.split(Gp),u=c.length-1;o<u;o++)r+=c[o]+i[o];return r+c[u]},Gp=function(){var e=`(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b`,t;for(t in Bp)e+=`|`+t+`\\b`;return RegExp(e+`)`,`gi`)}(),Kp=/hsl[a]?\(/,qp=function(e){var t=e.join(` `),n;if(Gp.lastIndex=0,Gp.test(t))return n=Kp.test(t),e[1]=Wp(e[1],n),e[0]=Wp(e[0],n,Up(e[1])),!0},Jp,Yp=function(){var e=Date.now,t=500,n=33,r=e(),i=r,a=1e3/240,o=a,s=[],c,l,u,d,f,p,m=function u(m){var h=e()-i,g=m===!0,_,v,y,b;if((h>t||h<0)&&(r+=h-n),i+=h,y=i-r,_=y-o,(_>0||g)&&(b=++d.frame,f=y-d.time*1e3,d.time=y/=1e3,o+=_+(_>=a?4:a-_),v=1),g||(c=l(u)),v)for(p=0;p<s.length;p++)s[p](y,f,b,m)};return d={time:0,frame:0,tick:function(){m(!0)},deltaRatio:function(e){return f/(1e3/(e||60))},wake:function(){ef&&(!Xd&&Fd()&&(Yd=Xd=window,Zd=Yd.document||{},Qd.gsap=$m,(Yd.gsapVersions||=[]).push($m.version),tf($d||Yd.GreenSockGlobals||!Yd.gsap&&Yd||{}),Lp.forEach(Rp)),u=typeof requestAnimationFrame<`u`&&requestAnimationFrame,c&&d.sleep(),l=u||function(e){return setTimeout(e,o-d.time*1e3+1|0)},Jp=1,m(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(c),Jp=0,l=of},lagSmoothing:function(e,r){t=e||1/0,n=Math.min(r||33,t)},fps:function(e){a=1e3/(e||240),o=d.time*1e3+a},add:function(e,t,n){var r=t?function(t,n,i,a){e(t,n,i,a),d.remove(r)}:e;return d.remove(e),s[n?`unshift`:`push`](r),Xp(),r},remove:function(e,t){~(t=s.indexOf(e))&&s.splice(t,1)&&p>=t&&p--},_listeners:s},d}(),Xp=function(){return!Jp&&Yp.wake()},$={},Zp=/^[\d.\-M][\d.\-,\s]/,Qp=/["']/g,$p=function(e){for(var t={},n=e.substr(1,e.length-3).split(`:`),r=n[0],i=1,a=n.length,o,s,c;i<a;i++)s=n[i],o=i===a-1?s.length:s.lastIndexOf(`,`),c=s.substr(0,o),t[r]=isNaN(c)?c.replace(Qp,``).trim():+c,r=s.substr(o+1).trim();return t},em=function(e){var t=e.indexOf(`(`)+1,n=e.indexOf(`)`),r=e.indexOf(`(`,t);return e.substring(t,~r&&r<n?e.indexOf(`)`,n+1):n)},tm=function(e){var t=(e+``).split(`(`),n=$[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf(`{`)?[$p(t[1])]:em(e).split(`,`).map(Af)):$._CE&&Zp.test(e)?$._CE(``,e):n},nm=function(e){return function(t){return 1-e(1-t)}},rm=function e(t,n){for(var r=t._first,i;r;)r instanceof dm?e(r,n):r.vars.yoyoEase&&(!r._yoyo||!r._repeat)&&r._yoyo!==n&&(r.timeline?e(r.timeline,n):(i=r._ease,r._ease=r._yEase,r._yEase=i,r._yoyo=n)),r=r._next},im=function(e,t){return e&&(Ad(e)?e:$[e]||tm(e))||t},am=function(e,t,n,r){n===void 0&&(n=function(e){return 1-t(1-e)}),r===void 0&&(r=function(e){return e<.5?t(e*2)/2:1-t((1-e)*2)/2});var i={easeIn:t,easeOut:n,easeInOut:r},a;return Sf(e,function(e){for(var t in $[e]=Qd[e]=i,$[a=e.toLowerCase()]=n,i)$[a+(t===`easeIn`?`.in`:t===`easeOut`?`.out`:`.inOut`)]=$[e+`.`+t]=i[t]}),i},om=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},sm=function e(t,n,r){var i=n>=1?n:1,a=(r||(t?.3:.45))/(n<1?n:1),o=a/Cd*(Math.asin(1/i)||0),s=function(e){return e===1?1:i*2**(-10*e)*Od((e-o)*a)+1},c=t===`out`?s:t===`in`?function(e){return 1-s(1-e)}:om(s);return a=Cd/a,c.config=function(n,r){return e(t,n,r)},c},cm=function e(t,n){n===void 0&&(n=1.70158);var r=function(e){return e?--e*e*((n+1)*e+n)+1:0},i=t===`out`?r:t===`in`?function(e){return 1-r(1-e)}:om(r);return i.config=function(n){return e(t,n)},i};Sf(`Linear,Quad,Cubic,Quart,Quint,Strong`,function(e,t){var n=t<5?t+1:t;am(e+`,Power`+(n-1),t?function(e){return e**+n}:function(e){return e},function(e){return 1-(1-e)**n},function(e){return e<.5?(e*2)**n/2:1-((1-e)*2)**n/2})}),$.Linear.easeNone=$.none=$.Linear.easeIn,am(`Elastic`,sm(`in`),sm(`out`),sm()),(function(e,t){var n=1/t,r=2*n,i=2.5*n,a=function(a){return a<n?e*a*a:a<r?e*(a-1.5/t)**2+.75:a<i?e*(a-=2.25/t)*a+.9375:e*(a-2.625/t)**2+.984375};am(`Bounce`,function(e){return 1-a(1-e)},a)})(7.5625,2.75),am(`Expo`,function(e){return 2**(10*(e-1))*e+e*e*e*e*e*e*(1-e)}),am(`Circ`,function(e){return-(Ed(1-e*e)-1)}),am(`Sine`,function(e){return e===1?1:-Dd(e*wd)+1}),am(`Back`,cm(`in`),cm(`out`),cm()),$.SteppedEase=$.steps=Qd.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+(t?0:1),i=t?1:0,a=1-Sd;return function(e){return((r*dp(0,a,e)|0)+i)*n}}},_d.ease=$[`quad.out`],Sf(`onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt`,function(e){return vf+=e+`,`+e+`Params,`});var lm=function(e,t){this.id=Td++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:xf,this.set=t?t.getSetter:Am},um=function(){function e(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,ap(this,+e.duration,1,1),this.data=e.data,bd&&(this._ctx=bd,bd.data.push(this)),Jp||Yp.wake()}var t=e.prototype;return t.delay=function(e){return e||e===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+e-this._delay),this._delay=e,this):this._delay},t.duration=function(e){return arguments.length?this.totalDuration(this._repeat>0?e+(e+this._rDelay)*this._repeat:e):this.totalDuration()&&this._dur},t.totalDuration=function(e){return arguments.length?(this._dirty=0,ap(this,this._repeat<0?e:(e-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(e,t){if(Xp(),!arguments.length)return this._tTime;var n=this._dp;if(n&&n.smoothChildTiming&&this._ts){for(Xf(this,e),!n._dp||n.parent||Zf(n,this);n&&n.parent;)n.parent._time!==n._start+(n._ts>=0?n._tTime/n._ts:(n.totalDuration()-n._tTime)/-n._ts)&&n.totalTime(n._tTime,!0),n=n.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&e<this._tDur||this._ts<0&&e>0||!this._tDur&&!e)&&Qf(this._dp,this,this._start-this._delay)}return(this._tTime!==e||!this._dur&&!t||this._initted&&Math.abs(this._zTime)===Sd||!this._initted&&this._dur&&e||!e&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=e),kf(this,e,t)),this},t.time=function(e,t){return arguments.length?this.totalTime(Math.min(this.totalDuration(),e+Kf(this))%(this._dur+this._rDelay)||(e?this._dur:0),t):this._time},t.totalProgress=function(e,t){return arguments.length?this.totalTime(this.totalDuration()*e,t):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(e,t){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-e:e)+Kf(this),t):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(e,t){var n=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(e-1)*n,t):this._repeat?qf(this._tTime,n)+1:1},t.timeScale=function(e,t){if(!arguments.length)return this._rts===-Sd?0:this._rts;if(this._rts===e)return this;var n=this.parent&&this._ts?Jf(this.parent._time,this):this._tTime;return this._rts=+e||0,this._ts=this._ps||e===-Sd?0:this._rts,this.totalTime(dp(-Math.abs(this._delay),this.totalDuration(),n),t!==!1),Yf(this),Uf(this)},t.paused=function(e){return arguments.length?(this._ps!==e&&(this._ps=e,e?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Xp(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Sd&&(this._tTime-=Sd)))),this):this._ps},t.startTime=function(e){if(arguments.length){this._start=wf(e);var t=this.parent||this._dp;return t&&(t._sort||!this.parent)&&Qf(t,this,this._start-this._delay),this}return this._start},t.endTime=function(e){return this._start+(Pd(e)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(e){var t=this.parent||this._dp;return t?e&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Jf(t.rawTime(e),this):this._tTime:this._tTime},t.revert=function(e){e===void 0&&(e=lf);var t=yd;return yd=e,Of(this)&&(this.timeline&&this.timeline.revert(e),this.totalTime(-.01,e.suppressEvents)),this.data!==`nested`&&e.kill!==!1&&this.kill(),yd=t,this},t.globalTime=function(e){for(var t=this,n=arguments.length?e:t.rawTime();t;)n=t._start+n/(Math.abs(t._ts)||1),t=t._dp;return!this.parent&&this._sat?this._sat.globalTime(e):n},t.repeat=function(e){return arguments.length?(this._repeat=e===1/0?-2:e,op(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(e){if(arguments.length){var t=this._time;return this._rDelay=e,op(this),t?this.time(t):this}return this._rDelay},t.yoyo=function(e){return arguments.length?(this._yoyo=e,this):this._yoyo},t.seek=function(e,t){return this.totalTime(cp(this,e),Pd(t))},t.restart=function(e,t){return this.play().totalTime(e?-this._delay:0,Pd(t)),this._dur||(this._zTime=-Sd),this},t.play=function(e,t){return e!=null&&this.seek(e,t),this.reversed(!1).paused(!1)},t.reverse=function(e,t){return e!=null&&this.seek(e||this.totalDuration(),t),this.reversed(!0).paused(!1)},t.pause=function(e,t){return e!=null&&this.seek(e,t),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(e){return arguments.length?(!!e!==this.reversed()&&this.timeScale(-this._rts||(e?-Sd:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Sd,this},t.isActive=function(){var e=this.parent||this._dp,t=this._start,n;return!!(!e||this._ts&&this._initted&&e.isActive()&&(n=e.rawTime(!0))>=t&&n<this.endTime(!0)-Sd)},t.eventCallback=function(e,t,n){var r=this.vars;return arguments.length>1?(t?(r[e]=t,n&&(r[e+`Params`]=n),e===`onUpdate`&&(this._onUpdate=t)):delete r[e],this):r[e]},t.then=function(e){var t=this,n=t._prom;return new Promise(function(r){var i=Ad(e)?e:jf,a=function(){var e=t.then;t.then=null,n&&n(),Ad(i)&&(i=i(t))&&(i.then||i===t)&&(t.then=e),r(i),t.then=e};t._initted&&t.totalProgress()===1&&t._ts>=0||!t._tTime&&t._ts<0?a():t._prom=a})},t.kill=function(){Fp(this)},e}();Mf(um.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Sd,_prom:0,_ps:!1,_rts:1});var dm=function(e){hd(t,e);function t(t,n){var r;return t===void 0&&(t={}),r=e.call(this,t)||this,r.labels={},r.smoothChildTiming=!!t.smoothChildTiming,r.autoRemoveChildren=!!t.autoRemoveChildren,r._sort=Pd(t.sortChildren),Jd&&Qf(t.parent||Jd,md(r),n),t.reversed&&r.reverse(),t.paused&&r.paused(!0),t.scrollTrigger&&$f(md(r),t.scrollTrigger),r}var n=t.prototype;return n.to=function(e,t,n){return lp(0,arguments,this),this},n.from=function(e,t,n){return lp(1,arguments,this),this},n.fromTo=function(e,t,n,r){return lp(2,arguments,this),this},n.set=function(e,t,n){return t.duration=0,t.parent=this,Lf(t).repeatDelay||(t.repeat=0),t.immediateRender=!!t.immediateRender,new Tm(e,t,cp(this,n),1),this},n.call=function(e,t,n){return Qf(this,Tm.delayedCall(0,e,t),n)},n.staggerTo=function(e,t,n,r,i,a,o){return n.duration=t,n.stagger=n.stagger||r,n.onComplete=a,n.onCompleteParams=o,n.parent=this,new Tm(e,n,cp(this,i)),this},n.staggerFrom=function(e,t,n,r,i,a,o){return n.runBackwards=1,Lf(n).immediateRender=Pd(n.immediateRender),this.staggerTo(e,t,n,r,i,a,o)},n.staggerFromTo=function(e,t,n,r,i,a,o,s){return r.startAt=n,Lf(r).immediateRender=Pd(r.immediateRender),this.staggerTo(e,t,r,i,a,o,s)},n.render=function(e,t,n){var r=this._time,i=this._dirty?this.totalDuration():this._tDur,a=this._dur,o=e<=0?0:wf(e),s=this._zTime<0!=e<0&&(this._initted||!a),c,l,u,d,f,p,m,h,g,_,v,y;if(this!==Jd&&o>i&&e>=0&&(o=i),o!==this._tTime||n||s){if(r!==this._time&&a&&(o+=this._time-r,e+=this._time-r),c=o,g=this._start,h=this._ts,p=!h,s&&(a||(r=this._zTime),(e||!t)&&(this._zTime=e)),this._repeat){if(v=this._yoyo,f=a+this._rDelay,this._repeat<-1&&e<0)return this.totalTime(f*100+e,t,n);if(c=wf(o%f),o===i?(d=this._repeat,c=a):(_=wf(o/f),d=~~_,d&&d===_&&(c=a,d--),c>a&&(c=a)),_=qf(this._tTime,f),!r&&this._tTime&&_!==d&&this._tTime-_*f-this._dur<=0&&(_=d),v&&d&1&&(c=a-c,y=1),d!==_&&!this._lock){var b=v&&_&1,x=b===(v&&d&1);if(d<_&&(b=!b),r=b?0:o%a?a:o,this._lock=1,this.render(r||(y?0:wf(d*f)),t,!a)._lock=0,this._tTime=o,!t&&this.parent&&Pp(this,`onRepeat`),this.vars.repeatRefresh&&!y&&(this.invalidate()._lock=1,_=d),r&&r!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act||(a=this._dur,i=this._tDur,x&&(this._lock=2,r=b?a:-1e-4,this.render(r,!0),this.vars.repeatRefresh&&!y&&this.invalidate()),this._lock=0,!this._ts&&!p))return this;rm(this,y)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(m=ip(this,wf(r),wf(c)),m&&(o-=c-(c=m._start))),this._tTime=o,this._time=c,this._act=!h,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=e,r=0),!r&&o&&a&&!t&&!_&&(Pp(this,`onStart`),this._tTime!==o))return this;if(c>=r&&e>=0)for(l=this._first;l;){if(u=l._next,(l._act||c>=l._start)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(c-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(c-l._start)*l._ts,t,n),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=-Sd);break}}l=u}else{l=this._last;for(var S=e<0?e:c;l;){if(u=l._prev,(l._act||S<=l._end)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(S-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(S-l._start)*l._ts,t,n||yd&&Of(l)),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=S?-Sd:Sd);break}}l=u}}if(m&&!t&&(this.pause(),m.render(c>=r?0:-Sd)._zTime=c>=r?1:-1,this._ts))return this._start=g,Yf(this),this.render(e,t,n);this._onUpdate&&!t&&Pp(this,`onUpdate`,!0),(o===i&&this._tTime>=this.totalDuration()||!o&&r)&&(g===this._start||Math.abs(h)!==Math.abs(this._ts))&&(this._lock||((e||!a)&&(o===i&&this._ts>0||!o&&this._ts<0)&&Vf(this,1),!t&&!(e<0&&!r)&&(o||r||!i)&&(Pp(this,o===i&&e>=0?`onComplete`:`onReverseComplete`,!0),this._prom&&!(o<i&&this.timeScale()>0)&&this._prom())))}return this},n.add=function(e,t){var n=this;if(jd(t)||(t=cp(this,t,e)),!(e instanceof um)){if(Rd(e))return e.forEach(function(e){return n.add(e,t)}),this;if(kd(e))return this.addLabel(e,t);if(Ad(e))e=Tm.delayedCall(0,e);else return this}return this===e?this:Qf(this,e,t)},n.getChildren=function(e,t,n,r){e===void 0&&(e=!0),t===void 0&&(t=!0),n===void 0&&(n=!0),r===void 0&&(r=-xd);for(var i=[],a=this._first;a;)a._start>=r&&(a instanceof Tm?t&&i.push(a):(n&&i.push(a),e&&i.push.apply(i,a.getChildren(!0,t,n)))),a=a._next;return i},n.getById=function(e){for(var t=this.getChildren(1,1,1),n=t.length;n--;)if(t[n].vars.id===e)return t[n]},n.remove=function(e){return kd(e)?this.removeLabel(e):Ad(e)?this.killTweensOf(e):(e.parent===this&&Bf(this,e),e===this._recent&&(this._recent=this._last),Hf(this))},n.totalTime=function(t,n){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=wf(Yp.time-(this._ts>0?t/this._ts:(this.totalDuration()-t)/-this._ts))),e.prototype.totalTime.call(this,t,n),this._forcing=0,this):this._tTime},n.addLabel=function(e,t){return this.labels[e]=cp(this,t),this},n.removeLabel=function(e){return delete this.labels[e],this},n.addPause=function(e,t,n){var r=Tm.delayedCall(0,t||of,n);return r.data=`isPause`,this._hasPause=1,Qf(this,r,cp(this,e))},n.removePause=function(e){var t=this._first;for(e=cp(this,e);t;)t._start===e&&t.data===`isPause`&&Vf(t),t=t._next},n.killTweensOf=function(e,t,n){for(var r=this.getTweensOf(e,n),i=r.length;i--;)gm!==r[i]&&r[i].kill(e,t);return this},n.getTweensOf=function(e,t){for(var n=[],r=_p(e),i=this._first,a=jd(t),o;i;)i instanceof Tm?Ef(i._targets,r)&&(a?(!gm||i._initted&&i._ts)&&i.globalTime(0)<=t&&i.globalTime(i.totalDuration())>t:!t||i.isActive())&&n.push(i):(o=i.getTweensOf(r,t)).length&&n.push.apply(n,o),i=i._next;return n},n.tweenTo=function(e,t){t||={};var n=this,r=cp(n,e),i=t,a=i.startAt,o=i.onStart,s=i.onStartParams,c=i.immediateRender,l,u=Tm.to(n,Mf({ease:t.ease||`none`,lazy:!1,immediateRender:!1,time:r,overwrite:`auto`,duration:t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale())||Sd,onStart:function(){if(n.pause(),!l){var e=t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale());u._dur!==e&&ap(u,e,0,1).render(u._time,!0,!0),l=1}o&&o.apply(u,s||[])}},t));return c?u.render(0):u},n.tweenFromTo=function(e,t,n){return this.tweenTo(t,Mf({startAt:{time:cp(this,e)}},n))},n.recent=function(){return this._recent},n.nextLabel=function(e){return e===void 0&&(e=this._time),Np(this,cp(this,e))},n.previousLabel=function(e){return e===void 0&&(e=this._time),Np(this,cp(this,e),1)},n.currentLabel=function(e){return arguments.length?this.seek(e,!0):this.previousLabel(this._time+Sd)},n.shiftChildren=function(e,t,n){n===void 0&&(n=0);var r=this._first,i=this.labels,a;for(e=wf(e);r;)r._start>=n&&(r._start+=e,r._end+=e),r=r._next;if(t)for(a in i)i[a]>=n&&(i[a]+=e);return Hf(this)},n.invalidate=function(t){var n=this._first;for(this._lock=0;n;)n.invalidate(t),n=n._next;return e.prototype.invalidate.call(this,t)},n.clear=function(e){e===void 0&&(e=!0);for(var t=this._first,n;t;)n=t._next,this.remove(t),t=n;return this._dp&&(this._time=this._tTime=this._pTime=0),e&&(this.labels={}),Hf(this)},n.totalDuration=function(e){var t=0,n=this,r=n._last,i=xd,a,o,s;if(arguments.length)return n.timeScale((n._repeat<0?n.duration():n.totalDuration())/(n.reversed()?-e:e));if(n._dirty){for(s=n.parent;r;)a=r._prev,r._dirty&&r.totalDuration(),o=r._start,o>i&&n._sort&&r._ts&&!n._lock?(n._lock=1,Qf(n,r,o-r._delay,1)._lock=0):i=o,o<0&&r._ts&&(t-=o,(!s&&!n._dp||s&&s.smoothChildTiming)&&(n._start+=wf(o/n._ts),n._time-=o,n._tTime-=o),n.shiftChildren(-o,!1,-1/0),i=0),r._end>t&&r._ts&&(t=r._end),r=a;ap(n,n===Jd&&n._time>t?n._time:t,1,1),n._dirty=0}return n._tDur},t.updateRoot=function(e){if(Jd._ts&&(kf(Jd,Jf(e,Jd)),pf=Yp.frame),Yp.frame>=gf){gf+=gd.autoSleep||120;var t=Jd._first;if((!t||!t._ts)&&gd.autoSleep&&Yp._listeners.length<2){for(;t&&!t._ts;)t=t._next;t||Yp.sleep()}}},t}(um);Mf(dm.prototype,{_lock:0,_hasPause:0,_forcing:0});var fm=function(e,t,n,r,i,a,o){var s=new zm(this._pt,e,t,0,1,Nm,null,i),c=0,l=0,u,d,f,p,m,h,g,_;for(s.b=n,s.e=r,n+=``,r+=``,(g=~r.indexOf(`random(`))&&(r=Ap(r)),a&&(_=[n,r],a(_,e,t),n=_[0],r=_[1]),d=n.match(Wd)||[];u=Wd.exec(r);)p=u[0],m=r.substring(c,u.index),f?f=(f+1)%5:m.substr(-5)===`rgba(`&&(f=1),p!==d[l++]&&(h=parseFloat(d[l-1])||0,s._pt={_next:s._pt,p:m||l===1?m:`,`,s:h,c:p.charAt(1)===`=`?Tf(h,p)-h:parseFloat(p)-h,m:f&&f<4?Math.round:0},c=Wd.lastIndex);return s.c=c<r.length?r.substring(c,r.length):``,s.fp=o,(Gd.test(r)||g)&&(s.e=0),this._pt=s,s},pm=function(e,t,n,r,i,a,o,s,c,l){Ad(r)&&(r=r(i||0,e,a));var u=e[t],d=n===`get`?Ad(u)?c?e[t.indexOf(`set`)||!Ad(e[`get`+t.substr(3)])?t:`get`+t.substr(3)](c):e[t]():u:n,f=Ad(u)?c?Om:Dm:Em,p;if(kd(r)&&(~r.indexOf(`random(`)&&(r=Ap(r)),r.charAt(1)===`=`&&(p=Tf(d,r)+(fp(d)||0),(p||p===0)&&(r=p))),!l||d!==r||_m)return!isNaN(d*r)&&r!==``?(p=new zm(this._pt,e,t,+d||0,r-(d||0),typeof u==`boolean`?Mm:jm,0,f),c&&(p.fp=c),o&&p.modifier(o,this,e),this._pt=p):(!u&&!(t in e)&&nf(t,r),fm.call(this,e,t,d,r,f,s||gd.stringFilter,c))},mm=function(e,t,n,r,i){if(Ad(e)&&(e=Sm(e,i,t,n,r)),!Nd(e)||e.style&&e.nodeType||Rd(e)||Ld(e))return kd(e)?Sm(e,i,t,n,r):e;var a={},o;for(o in e)a[o]=Sm(e[o],i,t,n,r);return a},hm=function(e,t,n,r,i,a){var o,s,c,l;if(mf[e]&&(o=new mf[e]).init(i,o.rawVars?t[e]:mm(t[e],r,i,a,n),n,r,a)!==!1&&(n._pt=s=new zm(n._pt,i,e,0,1,o.render,o,0,o.priority),n!==Ip))for(c=n._ptLookup[n._targets.indexOf(i)],l=o._props.length;l--;)c[o._props[l]]=s;return o},gm,_m,vm=function e(t,n,r){var i=t.vars,a=i.ease,o=i.startAt,s=i.immediateRender,c=i.lazy,l=i.onUpdate,u=i.runBackwards,d=i.yoyoEase,f=i.keyframes,p=i.autoRevert,m=t._dur,h=t._startAt,g=t._targets,_=t.parent,v=_&&_.data===`nested`?_.vars.targets:g,y=t._overwrite===`auto`&&!vd,b=t.timeline,x,S,C,w,T,E,D,O,k,A,ee,j,M;if(b&&(!f||!a)&&(a=`none`),t._ease=im(a,_d.ease),t._yEase=d?nm(im(d===!0?a:d,_d.ease)):0,d&&t._yoyo&&!t._repeat&&(d=t._yEase,t._yEase=t._ease,t._ease=d),t._from=!b&&!!i.runBackwards,!b||f&&!i.stagger){if(O=g[0]?bf(g[0]).harness:0,j=O&&i[O.prop],x=If(i,uf),h&&(h._zTime<0&&h.progress(1),n<0&&u&&s&&!p?h.render(-1,!0):h.revert(u&&m?cf:sf),h._lazy=0),o){if(Vf(t._startAt=Tm.set(g,Mf({data:`isStart`,overwrite:!1,parent:_,immediateRender:!0,lazy:!h&&Pd(c),startAt:null,delay:0,onUpdate:l&&function(){return Pp(t,`onUpdate`)},stagger:0},o))),t._startAt._dp=0,t._startAt._sat=t,n<0&&(yd||!s&&!p)&&t._startAt.revert(cf),s&&m&&n<=0&&r<=0){n&&(t._zTime=n);return}}else if(u&&m&&!h){if(n&&(s=!1),C=Mf({overwrite:!1,data:`isFromStart`,lazy:s&&!h&&Pd(c),immediateRender:s,stagger:0,parent:_},x),j&&(C[O.prop]=j),Vf(t._startAt=Tm.set(g,C)),t._startAt._dp=0,t._startAt._sat=t,n<0&&(yd?t._startAt.revert(cf):t._startAt.render(-1,!0)),t._zTime=n,!s)e(t._startAt,Sd,Sd);else if(!n)return}for(t._pt=t._ptCache=0,c=m&&Pd(c)||c&&!m,S=0;S<g.length;S++){if(T=g[S],D=T._gsap||yf(g)[S]._gsap,t._ptLookup[S]=A={},ff[D.id]&&df.length&&Df(),ee=v===g?S:v.indexOf(T),O&&(k=new O).init(T,j||x,t,ee,v)!==!1&&(t._pt=w=new zm(t._pt,T,k.name,0,1,k.render,k,0,k.priority),k._props.forEach(function(e){A[e]=w}),k.priority&&(E=1)),!O||j)for(C in x)mf[C]&&(k=hm(C,x,t,ee,T,v))?k.priority&&(E=1):A[C]=w=pm.call(t,T,C,`get`,x[C],ee,v,0,i.stringFilter);t._op&&t._op[S]&&t.kill(T,t._op[S]),y&&t._pt&&(gm=t,Jd.killTweensOf(T,A,t.globalTime(n)),M=!t.parent,gm=0),t._pt&&c&&(ff[D.id]=1)}E&&Rm(t),t._onInit&&t._onInit(t)}t._onUpdate=l,t._initted=(!t._op||t._pt)&&!M,f&&n<=0&&b.render(xd,!0,!0)},ym=function(e,t,n,r,i,a,o,s){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],l,u,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(l=d[f][t],l&&l.d&&l.d._pt)for(l=l.d._pt;l&&l.p!==t&&l.fp!==t;)l=l._next;if(!l)return _m=1,e.vars[t]=`+=0`,vm(e,o),_m=0,s?rf(t+` not eligible for reset`):1;c.push(l)}for(f=c.length;f--;)u=c[f],l=u._pt||u,l.s=(r||r===0)&&!i?r:l.s+(r||0)+a*l.c,l.c=n-l.s,u.e&&=Cf(n)+fp(u.e),u.b&&=l.s+fp(u.b)},bm=function(e,t){var n=e[0]?bf(e[0]).harness:0,r=n&&n.aliases,i,a,o,s;if(!r)return t;for(a in i=Pf({},t),r)if(a in i)for(s=r[a].split(`,`),o=s.length;o--;)i[s[o]]=i[a];return i},xm=function(e,t,n,r){var i=t.ease||r||`power1.inOut`,a,o;if(Rd(t))o=n[e]||(n[e]=[]),t.forEach(function(e,n){return o.push({t:n/(t.length-1)*100,v:e,e:i})});else for(a in t)o=n[a]||(n[a]=[]),a===`ease`||o.push({t:parseFloat(e),v:t[a],e:i})},Sm=function(e,t,n,r,i){return Ad(e)?e.call(t,n,r,i):kd(e)&&~e.indexOf(`random(`)?Ap(e):e},Cm=vf+`repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert`,wm={};Sf(Cm+`,id,stagger,delay,duration,paused,scrollTrigger`,function(e){return wm[e]=1});var Tm=function(e){hd(t,e);function t(t,n,r,i){var a;typeof n==`number`&&(r.duration=n,n=r,r=null),a=e.call(this,i?n:Lf(n))||this;var o=a.vars,s=o.duration,c=o.delay,l=o.immediateRender,u=o.stagger,d=o.overwrite,f=o.keyframes,p=o.defaults,m=o.scrollTrigger,h=o.yoyoEase,g=n.parent||Jd,_=(Rd(t)||Ld(t)?jd(t[0]):`length`in n)?[t]:_p(t),v,y,b,x,S,C,w,T;if(a._targets=_.length?yf(_):rf(`GSAP target `+t+` not found. https://gsap.com`,!gd.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=d,f||u||Id(s)||Id(c)){if(n=a.vars,v=a.timeline=new dm({data:`nested`,defaults:p||{},targets:g&&g.data===`nested`?g.vars.targets:_}),v.kill(),v.parent=v._dp=md(a),v._start=0,u||Id(s)||Id(c)){if(x=_.length,w=u&&bp(u),Nd(u))for(S in u)~Cm.indexOf(S)&&(T||={},T[S]=u[S]);for(y=0;y<x;y++)b=If(n,wm),b.stagger=0,h&&(b.yoyoEase=h),T&&Pf(b,T),C=_[y],b.duration=+Sm(s,md(a),y,C,_),b.delay=(+Sm(c,md(a),y,C,_)||0)-a._delay,!u&&x===1&&b.delay&&(a._delay=c=b.delay,a._start+=c,b.delay=0),v.to(C,b,w?w(y,C,_):0),v._ease=$.none;v.duration()?s=c=0:a.timeline=0}else if(f){Lf(Mf(v.vars.defaults,{ease:`none`})),v._ease=im(f.ease||n.ease||`none`);var E=0,D,O,k;if(Rd(f))f.forEach(function(e){return v.to(_,e,`>`)}),v.duration();else{for(S in b={},f)S===`ease`||S===`easeEach`||xm(S,f[S],b,f.easeEach);for(S in b)for(D=b[S].sort(function(e,t){return e.t-t.t}),E=0,y=0;y<D.length;y++)O=D[y],k={ease:O.e,duration:(O.t-(y?D[y-1].t:0))/100*s},k[S]=O.v,v.to(_,k,E),E+=k.duration;v.duration()<s&&v.to({},{duration:s-v.duration()})}}s||a.duration(s=v.duration())}else a.timeline=0;return d===!0&&!vd&&(gm=md(a),Jd.killTweensOf(_),gm=0),Qf(g,md(a),r),n.reversed&&a.reverse(),n.paused&&a.paused(!0),(l||!s&&!f&&a._start===wf(g._time)&&Pd(l)&&Gf(md(a))&&g.data!==`nested`)&&(a._tTime=-Sd,a.render(Math.max(0,-c)||0)),m&&$f(md(a),m),a}var n=t.prototype;return n.render=function(e,t,n){var r=this._time,i=this._tDur,a=this._dur,o=e<0,s=e>i-Sd&&!o?i:e<Sd?0:e,c,l,u,d,f,p,m,h,g;if(!a)rp(this,e,t,n);else if(s!==this._tTime||!e||n||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==o||this._lazy){if(c=s,h=this.timeline,this._repeat){if(d=a+this._rDelay,this._repeat<-1&&o)return this.totalTime(d*100+e,t,n);if(c=wf(s%d),s===i?(u=this._repeat,c=a):(f=wf(s/d),u=~~f,u&&u===f?(c=a,u--):c>a&&(c=a)),p=this._yoyo&&u&1,p&&(g=this._yEase,c=a-c),f=qf(this._tTime,d),c===r&&!n&&this._initted&&u===f)return this._tTime=s,this;u!==f&&(h&&this._yEase&&rm(h,p),this.vars.repeatRefresh&&!p&&!this._lock&&c!==d&&this._initted&&(this._lock=n=1,this.render(wf(d*u),!0).invalidate()._lock=0))}if(!this._initted){if(ep(this,o?e:c,n,t,s))return this._tTime=0,this;if(r!==this._time&&!(n&&this.vars.repeatRefresh&&u!==f))return this;if(a!==this._dur)return this.render(e,t,n)}if(this._tTime=s,this._time=c,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=m=(g||this._ease)(c/a),this._from&&(this.ratio=m=1-m),!r&&s&&!t&&!f&&(Pp(this,`onStart`),this._tTime!==s))return this;for(l=this._pt;l;)l.r(m,l.d),l=l._next;h&&h.render(e<0?e:h._dur*h._ease(c/this._dur),t,n)||this._startAt&&(this._zTime=e),this._onUpdate&&!t&&(o&&Wf(this,e,t,n),Pp(this,`onUpdate`)),this._repeat&&u!==f&&this.vars.onRepeat&&!t&&this.parent&&Pp(this,`onRepeat`),(s===this._tDur||!s)&&this._tTime===s&&(o&&!this._onUpdate&&Wf(this,e,!0,!0),(e||!a)&&(s===this._tDur&&this._ts>0||!s&&this._ts<0)&&Vf(this,1),!t&&!(o&&!r)&&(s||r||p)&&(Pp(this,s===i?`onComplete`:`onReverseComplete`,!0),this._prom&&!(s<i&&this.timeScale()>0)&&this._prom()))}return this},n.targets=function(){return this._targets},n.invalidate=function(t){return(!t||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(t),e.prototype.invalidate.call(this,t)},n.resetTo=function(e,t,n,r,i){Jp||Yp.wake(),this._ts||this.play();var a=Math.min(this._dur,(this._dp._time-this._start)*this._ts),o;return this._initted||vm(this,a),o=this._ease(a/this._dur),ym(this,e,t,n,r,o,a,i)?this.resetTo(e,t,n,r,1):(Xf(this,0),this.parent||zf(this._dp,this,`_first`,`_last`,this._dp._sort?`_start`:0),this.render(0))},n.kill=function(e,t){if(t===void 0&&(t=`all`),!e&&(!t||t===`all`))return this._lazy=this._pt=0,this.parent?Fp(this):this.scrollTrigger&&this.scrollTrigger.kill(!!yd),this;if(this.timeline){var n=this.timeline.totalDuration();return this.timeline.killTweensOf(e,t,gm&&gm.vars.overwrite!==!0)._first||Fp(this),this.parent&&n!==this.timeline.totalDuration()&&ap(this,this._dur*this.timeline._tDur/n,0,1),this}var r=this._targets,i=e?_p(e):r,a=this._ptLookup,o=this._pt,s,c,l,u,d,f,p;if((!t||t===`all`)&&Rf(r,i))return t===`all`&&(this._pt=0),Fp(this);for(s=this._op=this._op||[],t!==`all`&&(kd(t)&&(d={},Sf(t,function(e){return d[e]=1}),t=d),t=bm(r,t)),p=r.length;p--;)if(~i.indexOf(r[p]))for(d in c=a[p],t===`all`?(s[p]=t,u=c,l={}):(l=s[p]=s[p]||{},u=t),u)f=c&&c[d],f&&((!(`kill`in f.d)||f.d.kill(d)===!0)&&Bf(this,f,`_pt`),delete c[d]),l!==`all`&&(l[d]=1);return this._initted&&!this._pt&&o&&Fp(this),this},t.to=function(e,n){return new t(e,n,arguments[2])},t.from=function(e,t){return lp(1,arguments)},t.delayedCall=function(e,n,r,i){return new t(n,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:e,onComplete:n,onReverseComplete:n,onCompleteParams:r,onReverseCompleteParams:r,callbackScope:i})},t.fromTo=function(e,t,n){return lp(2,arguments)},t.set=function(e,n){return n.duration=0,n.repeatDelay||(n.repeat=0),new t(e,n)},t.killTweensOf=function(e,t,n){return Jd.killTweensOf(e,t,n)},t}(um);Mf(Tm.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0}),Sf(`staggerTo,staggerFrom,staggerFromTo`,function(e){Tm[e]=function(){var t=new dm,n=mp.call(arguments,0);return n.splice(e===`staggerFromTo`?5:4,0,0),t[e].apply(t,n)}});var Em=function(e,t,n){return e[t]=n},Dm=function(e,t,n){return e[t](n)},Om=function(e,t,n,r){return e[t](r.fp,n)},km=function(e,t,n){return e.setAttribute(t,n)},Am=function(e,t){return Ad(e[t])?Dm:Md(e[t])&&e.setAttribute?km:Em},jm=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},Mm=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},Nm=function(e,t){var n=t._pt,r=``;if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},Pm=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},Fm=function(e,t,n,r){for(var i=this._pt,a;i;)a=i._next,i.p===r&&i.modifier(e,t,n),i=a},Im=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?Bf(this,t,`_pt`):t.dep||(n=1),t=r;return!n},Lm=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},Rm=function(e){for(var t=e._pt,n,r,i,a;t;){for(n=t._next,r=i;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:a)?t._prev._next=t:i=t,(t._next=r)?r._prev=t:a=t,t=n}e._pt=i},zm=function(){function e(e,t,n,r,i,a,o,s,c){this.t=t,this.s=r,this.c=i,this.p=n,this.r=a||jm,this.d=o||this,this.set=s||Em,this.pr=c||0,this._next=e,e&&(e._prev=this)}var t=e.prototype;return t.modifier=function(e,t,n){this.mSet=this.mSet||this.set,this.set=Lm,this.m=e,this.mt=n,this.tween=t},e}();Sf(vf+`parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger`,function(e){return uf[e]=1}),Qd.TweenMax=Qd.TweenLite=Tm,Qd.TimelineLite=Qd.TimelineMax=dm,Jd=new dm({sortChildren:!1,defaults:_d,autoRemoveChildren:!0,id:`root`,smoothChildTiming:!0}),gd.stringFilter=qp;var Bm=[],Vm={},Hm=[],Um=0,Wm=0,Gm=function(e){return(Vm[e]||Hm).map(function(e){return e()})},Km=function(){var e=Date.now(),t=[];e-Um>2&&(Gm(`matchMediaInit`),Bm.forEach(function(e){var n=e.queries,r=e.conditions,i,a,o,s;for(a in n)i=Yd.matchMedia(n[a]).matches,i&&(o=1),i!==r[a]&&(r[a]=i,s=1);s&&(e.revert(),o&&t.push(e))}),Gm(`matchMediaRevert`),t.forEach(function(e){return e.onMatch(e,function(t){return e.add(null,t)})}),Um=e,Gm(`matchMedia`))},qm=function(){function e(e,t){this.selector=t&&vp(t),this.data=[],this._r=[],this.isReverted=!1,this.id=Wm++,e&&this.add(e)}var t=e.prototype;return t.add=function(e,t,n){Ad(e)&&(n=t,t=e,e=Ad);var r=this,i=function(){var e=bd,i=r.selector,a;return e&&e!==r&&e.data.push(r),n&&(r.selector=vp(n)),bd=r,a=t.apply(r,arguments),Ad(a)&&r._r.push(a),bd=e,r.selector=i,r.isReverted=!1,a};return r.last=i,e===Ad?i(r,function(e){return r.add(null,e)}):e?r[e]=i:i},t.ignore=function(e){var t=bd;bd=null,e(this),bd=t},t.getTweens=function(){var t=[];return this.data.forEach(function(n){return n instanceof e?t.push.apply(t,n.getTweens()):n instanceof Tm&&!(n.parent&&n.parent.data===`nested`)&&t.push(n)}),t},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(e,t){var n=this;if(e?(function(){for(var t=n.getTweens(),r=n.data.length,i;r--;)i=n.data[r],i.data===`isFlip`&&(i.revert(),i.getChildren(!0,!0,!1).forEach(function(e){return t.splice(t.indexOf(e),1)}));for(t.map(function(e){return{g:e._dur||e._delay||e._sat&&!e._sat.vars.immediateRender?e.globalTime(0):-1/0,t:e}}).sort(function(e,t){return t.g-e.g||-1/0}).forEach(function(t){return t.t.revert(e)}),r=n.data.length;r--;)i=n.data[r],i instanceof dm?i.data!==`nested`&&(i.scrollTrigger&&i.scrollTrigger.revert(),i.kill()):!(i instanceof Tm)&&i.revert&&i.revert(e);n._r.forEach(function(t){return t(e,n)}),n.isReverted=!0})():this.data.forEach(function(e){return e.kill&&e.kill()}),this.clear(),t)for(var r=Bm.length;r--;)Bm[r].id===this.id&&Bm.splice(r,1)},t.revert=function(e){this.kill(e||{})},e}(),Jm=function(){function e(e){this.contexts=[],this.scope=e,bd&&bd.data.push(this)}var t=e.prototype;return t.add=function(e,t,n){Nd(e)||(e={matches:e});var r=new qm(0,n||this.scope),i=r.conditions={},a,o,s;for(o in bd&&!r.selector&&(r.selector=bd.selector),this.contexts.push(r),t=r.add(`onMatch`,t),r.queries=e,e)o===`all`?s=1:(a=Yd.matchMedia(e[o]),a&&(Bm.indexOf(r)<0&&Bm.push(r),(i[o]=a.matches)&&(s=1),a.addListener?a.addListener(Km):a.addEventListener(`change`,Km)));return s&&t(r,function(e){return r.add(null,e)}),this},t.revert=function(e){this.kill(e||{})},t.kill=function(e){this.contexts.forEach(function(t){return t.kill(e,!0)})},e}(),Ym={registerPlugin:function(){[...arguments].forEach(function(e){return Rp(e)})},timeline:function(e){return new dm(e)},getTweensOf:function(e,t){return Jd.getTweensOf(e,t)},getProperty:function(e,t,n,r){kd(e)&&(e=_p(e)[0]);var i=bf(e||{}).get,a=n?jf:Af;return n===`native`&&(n=``),e&&(t?a((mf[t]&&mf[t].get||i)(e,t,n,r)):function(t,n,r){return a((mf[t]&&mf[t].get||i)(e,t,n,r))})},quickSetter:function(e,t,n){if(e=_p(e),e.length>1){var r=e.map(function(e){return $m.quickSetter(e,t,n)}),i=r.length;return function(e){for(var t=i;t--;)r[t](e)}}e=e[0]||{};var a=mf[t],o=bf(e),s=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(t){var r=new a;Ip._pt=0,r.init(e,n?t+n:t,Ip,0,[e]),r.render(1,r),Ip._pt&&Pm(1,Ip)}:o.set(e,s);return a?c:function(t){return c(e,s,n?t+n:t,o,1)}},quickTo:function(e,t,n){var r,i=$m.to(e,Mf((r={},r[t]=`+=0.1`,r.paused=!0,r.stagger=0,r),n||{})),a=function(e,n,r){return i.resetTo(t,e,n,r)};return a.tween=i,a},isTweening:function(e){return Jd.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=im(e.ease,_d.ease)),Ff(_d,e||{})},config:function(e){return Ff(gd,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,i=e.defaults,a=e.extendTimeline;(r||``).split(`,`).forEach(function(e){return e&&!mf[e]&&!Qd[e]&&rf(t+` effect requires `+e+` plugin.`)}),hf[t]=function(e,t,r){return n(_p(e),Mf(t||{},i),r)},a&&(dm.prototype[t]=function(e,n,r){return this.add(hf[t](e,Nd(n)?n:(r=n)&&{},this),r)})},registerEase:function(e,t){$[e]=im(t)},parseEase:function(e,t){return arguments.length?im(e,t):$},getById:function(e){return Jd.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new dm(e),r,i;for(n.smoothChildTiming=Pd(e.smoothChildTiming),Jd.remove(n),n._dp=0,n._time=n._tTime=Jd._time,r=Jd._first;r;)i=r._next,(t||!(!r._dur&&r instanceof Tm&&r.vars.onComplete===r._targets[0]))&&Qf(n,r,r._start-r._delay),r=i;return Qf(Jd,n,0),n},context:function(e,t){return e?new qm(e,t):bd},matchMedia:function(e){return new Jm(e)},matchMediaRefresh:function(){return Bm.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||Km()},addEventListener:function(e,t){var n=Vm[e]||(Vm[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Vm[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:Op,wrapYoyo:kp,distribute:bp,random:Cp,snap:Sp,normalize:Ep,getUnit:fp,clamp:pp,splitColor:Hp,toArray:_p,selector:vp,mapRange:jp,pipe:wp,unitize:Tp,interpolate:Mp,shuffle:yp},install:tf,effects:hf,ticker:Yp,updateRoot:dm.updateRoot,plugins:mf,globalTimeline:Jd,core:{PropTween:zm,globals:af,Tween:Tm,Timeline:dm,Animation:um,getCache:bf,_removeLinkedListItem:Bf,reverting:function(){return yd},context:function(e){return e&&bd&&(bd.data.push(e),e._ctx=bd),bd},suppressOverwrites:function(e){return vd=e}}};Sf(`to,from,fromTo,delayedCall,set,killTweensOf`,function(e){return Ym[e]=Tm[e]}),Yp.add(dm.updateRoot),Ip=Ym.to({},{duration:0});var Xm=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},Zm=function(e,t){var n=e._targets,r,i,a;for(r in t)for(i=n.length;i--;)a=e._ptLookup[i][r],(a&&=a.d)&&(a._pt&&(a=Xm(a,r)),a&&a.modifier&&a.modifier(t[r],e,n[i],r))},Qm=function(e,t){return{name:e,headless:1,rawVars:1,init:function(e,n,r){r._onInit=function(e){var r,i;if(kd(n)&&(r={},Sf(n,function(e){return r[e]=1}),n=r),t){for(i in r={},n)r[i]=t(n[i]);n=r}Zm(e,n)}}}},$m=Ym.registerPlugin({name:`attr`,init:function(e,t,n,r,i){var a,o,s;for(a in this.tween=n,t)s=e.getAttribute(a)||``,o=this.add(e,`setAttribute`,(s||0)+``,t[a],r,i,0,0,a),o.op=a,o.b=s,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)yd?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:`endArray`,headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Qm(`roundProps`,xp),Qm(`modifiers`),Qm(`snap`,Sp))||Ym;Tm.version=dm.version=$m.version=`3.14.2`,ef=1,Fd()&&Xp(),$.Power0,$.Power1,$.Power2,$.Power3,$.Power4,$.Linear,$.Quad,$.Cubic,$.Quart,$.Quint,$.Strong,$.Elastic,$.Back,$.SteppedEase,$.Bounce,$.Sine,$.Expo,$.Circ;var eh,th,nh,rh,ih,ah,oh,sh=function(){return typeof window<`u`},ch={},lh=180/Math.PI,uh=Math.PI/180,dh=Math.atan2,fh=1e8,ph=/([A-Z])/g,mh=/(left|right|width|margin|padding|x)/i,hh=/[\s,\(]\S/,gh={autoAlpha:`opacity,visibility`,scale:`scaleX,scaleY`,alpha:`opacity`},_h=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},vh=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},yh=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},bh=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},xh=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Sh=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Ch=function(e,t){return t.set(t.t,t.p,e===1?t.e:t.b,t)},wh=function(e,t,n){return e.style[t]=n},Th=function(e,t,n){return e.style.setProperty(t,n)},Eh=function(e,t,n){return e._gsap[t]=n},Dh=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Oh=function(e,t,n,r,i){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(i,a)},kh=function(e,t,n,r,i){var a=e._gsap;a[t]=n,a.renderTransform(i,a)},Ah=`transform`,jh=Ah+`Origin`,Mh=function e(t,n){var r=this,i=this.target,a=i.style,o=i._gsap;if(t in ch&&a){if(this.tfm=this.tfm||{},t!==`transform`)t=gh[t]||t,~t.indexOf(`,`)?t.split(`,`).forEach(function(e){return r.tfm[e]=Zh(i,e)}):this.tfm[t]=o.x?o[t]:Zh(i,t),t===jh&&(this.tfm.zOrigin=o.zOrigin);else return gh.transform.split(`,`).forEach(function(t){return e.call(r,t,n)});if(this.props.indexOf(Ah)>=0)return;o.svg&&(this.svgo=i.getAttribute(`data-svg-origin`),this.props.push(jh,n,``)),t=Ah}(a||n)&&this.props.push(t,n,a[t])},Nh=function(e){e.translate&&(e.removeProperty(`translate`),e.removeProperty(`scale`),e.removeProperty(`rotate`))},Ph=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,i,a;for(i=0;i<e.length;i+=3)e[i+1]?e[i+1]===2?t[e[i]](e[i+2]):t[e[i]]=e[i+2]:e[i+2]?n[e[i]]=e[i+2]:n.removeProperty(e[i].substr(0,2)===`--`?e[i]:e[i].replace(ph,`-$1`).toLowerCase());if(this.tfm){for(a in this.tfm)r[a]=this.tfm[a];r.svg&&(r.renderTransform(),t.setAttribute(`data-svg-origin`,this.svgo||``)),i=oh(),(!i||!i.isStart)&&!n[Ah]&&(Nh(n),r.zOrigin&&n[jh]&&(n[jh]+=` `+r.zOrigin+`px`,r.zOrigin=0,r.renderTransform()),r.uncache=1)}},Fh=function(e,t){var n={target:e,props:[],revert:Ph,save:Mh};return e._gsap||$m.core.getCache(e),t&&e.style&&e.nodeType&&t.split(`,`).forEach(function(e){return n.save(e)}),n},Ih,Lh=function(e,t){var n=th.createElementNS?th.createElementNS((t||`http://www.w3.org/1999/xhtml`).replace(/^https/,`http`),e):th.createElement(e);return n&&n.style?n:th.createElement(e)},Rh=function e(t,n,r){var i=getComputedStyle(t);return i[n]||i.getPropertyValue(n.replace(ph,`-$1`).toLowerCase())||i.getPropertyValue(n)||!r&&e(t,Bh(n)||n,1)||``},zh=`O,Moz,ms,Ms,Webkit`.split(`,`),Bh=function(e,t,n){var r=(t||ih).style,i=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);i--&&!(zh[i]+e in r););return i<0?null:(i===3?`ms`:i>=0?zh[i]:``)+e},Vh=function(){sh()&&window.document&&(eh=window,th=eh.document,nh=th.documentElement,ih=Lh(`div`)||{style:{}},Lh(`div`),Ah=Bh(Ah),jh=Ah+`Origin`,ih.style.cssText=`border-width:0;line-height:0;position:absolute;padding:0`,Ih=!!Bh(`perspective`),oh=$m.core.reverting,rh=1)},Hh=function(e){var t=e.ownerSVGElement,n=Lh(`svg`,t&&t.getAttribute(`xmlns`)||`http://www.w3.org/2000/svg`),r=e.cloneNode(!0),i;r.style.display=`block`,n.appendChild(r),nh.appendChild(n);try{i=r.getBBox()}catch{}return n.removeChild(r),nh.removeChild(n),i},Uh=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Wh=function(e){var t,n;try{t=e.getBBox()}catch{t=Hh(e),n=1}return t&&(t.width||t.height)||n||(t=Hh(e)),t&&!t.width&&!t.x&&!t.y?{x:+Uh(e,[`x`,`cx`,`x1`])||0,y:+Uh(e,[`y`,`cy`,`y1`])||0,width:0,height:0}:t},Gh=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Wh(e))},Kh=function(e,t){if(t){var n=e.style,r;t in ch&&t!==jh&&(t=Ah),n.removeProperty?(r=t.substr(0,2),(r===`ms`||t.substr(0,6)===`webkit`)&&(t=`-`+t),n.removeProperty(r===`--`?t:t.replace(ph,`-$1`).toLowerCase())):n.removeAttribute(t)}},qh=function(e,t,n,r,i,a){var o=new zm(e._pt,t,n,0,1,a?Ch:Sh);return e._pt=o,o.b=r,o.e=i,e._props.push(n),o},Jh={deg:1,rad:1,turn:1},Yh={grid:1,flex:1},Xh=function e(t,n,r,i){var a=parseFloat(r)||0,o=(r+``).trim().substr((a+``).length)||`px`,s=ih.style,c=mh.test(n),l=t.tagName.toLowerCase()===`svg`,u=(l?`client`:`offset`)+(c?`Width`:`Height`),d=100,f=i===`px`,p=i===`%`,m,h,g,_;if(i===o||!a||Jh[i]||Jh[o])return a;if(o!==`px`&&!f&&(a=e(t,n,r,`px`)),_=t.getCTM&&Gh(t),(p||o===`%`)&&(ch[n]||~n.indexOf(`adius`)))return m=_?t.getBBox()[c?`width`:`height`]:t[u],Cf(p?a/m*d:a/100*m);if(s[c?`width`:`height`]=d+(f?o:i),h=i!==`rem`&&~n.indexOf(`adius`)||i===`em`&&t.appendChild&&!l?t:t.parentNode,_&&(h=(t.ownerSVGElement||{}).parentNode),(!h||h===th||!h.appendChild)&&(h=th.body),g=h._gsap,g&&p&&g.width&&c&&g.time===Yp.time&&!g.uncache)return Cf(a/g.width*d);if(p&&(n===`height`||n===`width`)){var v=t.style[n];t.style[n]=d+i,m=t[u],v?t.style[n]=v:Kh(t,n)}else (p||o===`%`)&&!Yh[Rh(h,`display`)]&&(s.position=Rh(t,`position`)),h===t&&(s.position=`static`),h.appendChild(ih),m=ih[u],h.removeChild(ih),s.position=`absolute`;return c&&p&&(g=bf(h),g.time=Yp.time,g.width=h[u]),Cf(f?m*a/d:m&&a?d/m*a:0)},Zh=function(e,t,n,r){var i;return rh||Vh(),t in gh&&t!==`transform`&&(t=gh[t],~t.indexOf(`,`)&&(t=t.split(`,`)[0])),ch[t]&&t!==`transform`?(i=lg(e,r),i=t===`transformOrigin`?i.svg?i.origin:ug(Rh(e,jh))+` `+i.zOrigin+`px`:i[t]):(i=e.style[t],(!i||i===`auto`||r||~(i+``).indexOf(`calc(`))&&(i=ng[t]&&ng[t](e,t,n)||Rh(e,t)||xf(e,t)||(t===`opacity`?1:0))),n&&!~(i+``).trim().indexOf(` `)?Xh(e,t,i,n)+n:i},Qh=function(e,t,n,r){if(!n||n===`none`){var i=Bh(t,e,1),a=i&&Rh(e,i,1);a&&a!==n?(t=i,n=a):t===`borderColor`&&(n=Rh(e,`borderTopColor`))}var o=new zm(this._pt,e.style,t,0,1,Nm),s=0,c=0,l,u,d,f,p,m,h,g,_,v,y,b;if(o.b=n,o.e=r,n+=``,r+=``,r.substring(0,6)===`var(--`&&(r=Rh(e,r.substring(4,r.indexOf(`)`)))),r===`auto`&&(m=e.style[t],e.style[t]=r,r=Rh(e,t)||r,m?e.style[t]=m:Kh(e,t)),l=[n,r],qp(l),n=l[0],r=l[1],d=n.match(Ud)||[],b=r.match(Ud)||[],b.length){for(;u=Ud.exec(r);)h=u[0],_=r.substring(s,u.index),p?p=(p+1)%5:(_.substr(-5)===`rgba(`||_.substr(-5)===`hsla(`)&&(p=1),h!==(m=d[c++]||``)&&(f=parseFloat(m)||0,y=m.substr((f+``).length),h.charAt(1)===`=`&&(h=Tf(f,h)+y),g=parseFloat(h),v=h.substr((g+``).length),s=Ud.lastIndex-v.length,v||(v=v||gd.units[t]||y,s===r.length&&(r+=v,o.e+=v)),y!==v&&(f=Xh(e,t,m,v)||0),o._pt={_next:o._pt,p:_||c===1?_:`,`,s:f,c:g-f,m:p&&p<4||t===`zIndex`?Math.round:0});o.c=s<r.length?r.substring(s,r.length):``}else o.r=t===`display`&&r===`none`?Ch:Sh;return Gd.test(r)&&(o.e=0),this._pt=o,o},$h={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},eg=function(e){var t=e.split(` `),n=t[0],r=t[1]||`50%`;return(n===`top`||n===`bottom`||r===`left`||r===`right`)&&(e=n,n=r,r=e),t[0]=$h[n]||n,t[1]=$h[r]||r,t.join(` `)},tg=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,i=t.u,a=n._gsap,o,s,c;if(i===`all`||i===!0)r.cssText=``,s=1;else for(i=i.split(`,`),c=i.length;--c>-1;)o=i[c],ch[o]&&(s=1,o=o===`transformOrigin`?jh:Ah),Kh(n,o);s&&(Kh(n,Ah),a&&(a.svg&&n.removeAttribute(`transform`),r.scale=r.rotate=r.translate=`none`,lg(n,1),a.uncache=1,Nh(r)))}},ng={clearProps:function(e,t,n,r,i){if(i.data!==`isFromStart`){var a=e._pt=new zm(e._pt,t,n,0,0,tg);return a.u=r,a.pr=-10,a.tween=i,e._props.push(n),1}}},rg=[1,0,0,1,0,0],ig={},ag=function(e){return e===`matrix(1, 0, 0, 1, 0, 0)`||e===`none`||!e},og=function(e){var t=Rh(e,Ah);return ag(t)?rg:t.substr(7).match(Hd).map(Cf)},sg=function(e,t){var n=e._gsap||bf(e),r=e.style,i=og(e),a,o,s,c;return n.svg&&e.getAttribute(`transform`)?(s=e.transform.baseVal.consolidate().matrix,i=[s.a,s.b,s.c,s.d,s.e,s.f],i.join(`,`)===`1,0,0,1,0,0`?rg:i):(i===rg&&!e.offsetParent&&e!==nh&&!n.svg&&(s=r.display,r.display=`block`,a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,nh.appendChild(e)),i=og(e),s?r.display=s:Kh(e,`display`),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):nh.removeChild(e))),t&&i.length>6?[i[0],i[1],i[4],i[5],i[12],i[13]]:i)},cg=function(e,t,n,r,i,a){var o=e._gsap,s=i||sg(e,!0),c=o.xOrigin||0,l=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=s[0],p=s[1],m=s[2],h=s[3],g=s[4],_=s[5],v=t.split(` `),y=parseFloat(v[0])||0,b=parseFloat(v[1])||0,x,S,C,w;n?s!==rg&&(S=f*h-p*m)&&(C=h/S*y+b*(-m/S)+(m*_-h*g)/S,w=y*(-p/S)+f/S*b-(f*_-p*g)/S,y=C,b=w):(x=Wh(e),y=x.x+(~v[0].indexOf(`%`)?y/100*x.width:y),b=x.y+(~(v[1]||v[0]).indexOf(`%`)?b/100*x.height:b)),r||r!==!1&&o.smooth?(g=y-c,_=b-l,o.xOffset=u+(g*f+_*m)-g,o.yOffset=d+(g*p+_*h)-_):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=b,o.smooth=!!r,o.origin=t,o.originIsAbsolute=!!n,e.style[jh]=`0px 0px`,a&&(qh(a,o,`xOrigin`,c,y),qh(a,o,`yOrigin`,l,b),qh(a,o,`xOffset`,u,o.xOffset),qh(a,o,`yOffset`,d,o.yOffset)),e.setAttribute(`data-svg-origin`,y+` `+b)},lg=function(e,t){var n=e._gsap||new lm(e);if(`x`in n&&!t&&!n.uncache)return n;var r=e.style,i=n.scaleX<0,a=`px`,o=`deg`,s=getComputedStyle(e),c=Rh(e,jh)||`0`,l=u=d=m=h=g=_=v=y=0,u,d,f=p=1,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,ee,j,M,N,P,F,te,ne,I,re;return n.svg=!!(e.getCTM&&Gh(e)),s.translate&&((s.translate!==`none`||s.scale!==`none`||s.rotate!==`none`)&&(r[Ah]=(s.translate===`none`?``:`translate3d(`+(s.translate+` 0 0`).split(` `).slice(0,3).join(`, `)+`) `)+(s.rotate===`none`?``:`rotate(`+s.rotate+`) `)+(s.scale===`none`?``:`scale(`+s.scale.split(` `).join(`,`)+`) `)+(s[Ah]===`none`?``:s[Ah])),r.scale=r.rotate=r.translate=`none`),S=sg(e,n.svg),n.svg&&(n.uncache?(M=e.getBBox(),c=n.xOrigin-M.x+`px `+(n.yOrigin-M.y)+`px`,j=``):j=!t&&e.getAttribute(`data-svg-origin`),cg(e,j||c,!!j||n.originIsAbsolute,n.smooth!==!1,S)),b=n.xOrigin||0,x=n.yOrigin||0,S!==rg&&(E=S[0],D=S[1],O=S[2],k=S[3],l=A=S[4],u=ee=S[5],S.length===6?(f=Math.sqrt(E*E+D*D),p=Math.sqrt(k*k+O*O),m=E||D?dh(D,E)*lh:0,_=O||k?dh(O,k)*lh+m:0,_&&(p*=Math.abs(Math.cos(_*uh))),n.svg&&(l-=b-(b*E+x*O),u-=x-(b*D+x*k))):(re=S[6],ne=S[7],P=S[8],F=S[9],te=S[10],I=S[11],l=S[12],u=S[13],d=S[14],C=dh(re,te),h=C*lh,C&&(w=Math.cos(-C),T=Math.sin(-C),j=A*w+P*T,M=ee*w+F*T,N=re*w+te*T,P=A*-T+P*w,F=ee*-T+F*w,te=re*-T+te*w,I=ne*-T+I*w,A=j,ee=M,re=N),C=dh(-O,te),g=C*lh,C&&(w=Math.cos(-C),T=Math.sin(-C),j=E*w-P*T,M=D*w-F*T,N=O*w-te*T,I=k*T+I*w,E=j,D=M,O=N),C=dh(D,E),m=C*lh,C&&(w=Math.cos(C),T=Math.sin(C),j=E*w+D*T,M=A*w+ee*T,D=D*w-E*T,ee=ee*w-A*T,E=j,A=M),h&&Math.abs(h)+Math.abs(m)>359.9&&(h=m=0,g=180-g),f=Cf(Math.sqrt(E*E+D*D+O*O)),p=Cf(Math.sqrt(ee*ee+re*re)),C=dh(A,ee),_=Math.abs(C)>2e-4?C*lh:0,y=I?1/(I<0?-I:I):0),n.svg&&(j=e.getAttribute(`transform`),n.forceCSS=e.setAttribute(`transform`,``)||!ag(Rh(e,Ah)),j&&e.setAttribute(`transform`,j))),Math.abs(_)>90&&Math.abs(_)<270&&(i?(f*=-1,_+=m<=0?180:-180,m+=m<=0?180:-180):(p*=-1,_+=_<=0?180:-180)),t||=n.uncache,n.x=l-((n.xPercent=l&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-l)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=Cf(f),n.scaleY=Cf(p),n.rotation=Cf(m)+o,n.rotationX=Cf(h)+o,n.rotationY=Cf(g)+o,n.skewX=_+o,n.skewY=v+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(c.split(` `)[2])||!t&&n.zOrigin||0)&&(r[jh]=ug(c)),n.xOffset=n.yOffset=0,n.force3D=gd.force3D,n.renderTransform=n.svg?_g:Ih?gg:fg,n.uncache=0,n},ug=function(e){return(e=e.split(` `))[0]+` `+e[1]},dg=function(e,t,n){var r=fp(t);return Cf(parseFloat(t)+parseFloat(Xh(e,`x`,n+`px`,r)))+r},fg=function(e,t){t.z=`0px`,t.rotationY=t.rotationX=`0deg`,t.force3D=0,gg(e,t)},pg=`0deg`,mg=`0px`,hg=`) `,gg=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.z,c=n.rotation,l=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,p=n.scaleX,m=n.scaleY,h=n.transformPerspective,g=n.force3D,_=n.target,v=n.zOrigin,y=``,b=g===`auto`&&e&&e!==1||g===!0;if(v&&(u!==pg||l!==pg)){var x=parseFloat(l)*uh,S=Math.sin(x),C=Math.cos(x),w;x=parseFloat(u)*uh,w=Math.cos(x),a=dg(_,a,S*w*-v),o=dg(_,o,-Math.sin(x)*-v),s=dg(_,s,C*w*-v+v)}h!==mg&&(y+=`perspective(`+h+hg),(r||i)&&(y+=`translate(`+r+`%, `+i+`%) `),(b||a!==mg||o!==mg||s!==mg)&&(y+=s!==mg||b?`translate3d(`+a+`, `+o+`, `+s+`) `:`translate(`+a+`, `+o+hg),c!==pg&&(y+=`rotate(`+c+hg),l!==pg&&(y+=`rotateY(`+l+hg),u!==pg&&(y+=`rotateX(`+u+hg),(d!==pg||f!==pg)&&(y+=`skew(`+d+`, `+f+hg),(p!==1||m!==1)&&(y+=`scale(`+p+`, `+m+hg),_.style[Ah]=y||`translate(0, 0)`},_g=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.rotation,c=n.skewX,l=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,p=n.xOrigin,m=n.yOrigin,h=n.xOffset,g=n.yOffset,_=n.forceCSS,v=parseFloat(a),y=parseFloat(o),b,x,S,C,w;s=parseFloat(s),c=parseFloat(c),l=parseFloat(l),l&&(l=parseFloat(l),c+=l,s+=l),s||c?(s*=uh,c*=uh,b=Math.cos(s)*u,x=Math.sin(s)*u,S=Math.sin(s-c)*-d,C=Math.cos(s-c)*d,c&&(l*=uh,w=Math.tan(c-l),w=Math.sqrt(1+w*w),S*=w,C*=w,l&&(w=Math.tan(l),w=Math.sqrt(1+w*w),b*=w,x*=w)),b=Cf(b),x=Cf(x),S=Cf(S),C=Cf(C)):(b=u,C=d,x=S=0),(v&&!~(a+``).indexOf(`px`)||y&&!~(o+``).indexOf(`px`))&&(v=Xh(f,`x`,a,`px`),y=Xh(f,`y`,o,`px`)),(p||m||h||g)&&(v=Cf(v+p-(p*b+m*S)+h),y=Cf(y+m-(p*x+m*C)+g)),(r||i)&&(w=f.getBBox(),v=Cf(v+r/100*w.width),y=Cf(y+i/100*w.height)),w=`matrix(`+b+`,`+x+`,`+S+`,`+C+`,`+v+`,`+y+`)`,f.setAttribute(`transform`,w),_&&(f.style[Ah]=w)},vg=function(e,t,n,r,i){var a=360,o=kd(i),s=parseFloat(i)*(o&&~i.indexOf(`rad`)?lh:1)-r,c=r+s+`deg`,l,u;return o&&(l=i.split(`_`)[1],l===`short`&&(s%=a,s!==s%(a/2)&&(s+=s<0?a:-a)),l===`cw`&&s<0?s=(s+a*fh)%a-~~(s/a)*a:l===`ccw`&&s>0&&(s=(s-a*fh)%a-~~(s/a)*a)),e._pt=u=new zm(e._pt,t,n,r,s,vh),u.e=c,u.u=`deg`,e._props.push(n),u},yg=function(e,t){for(var n in t)e[n]=t[n];return e},bg=function(e,t,n){var r=yg({},n._gsap),i=`perspective,force3D,transformOrigin,svgOrigin`,a=n.style,o,s,c,l,u,d,f,p;for(s in r.svg?(c=n.getAttribute(`transform`),n.setAttribute(`transform`,``),a[Ah]=t,o=lg(n,1),Kh(n,Ah),n.setAttribute(`transform`,c)):(c=getComputedStyle(n)[Ah],a[Ah]=t,o=lg(n,1),a[Ah]=c),ch)c=r[s],l=o[s],c!==l&&i.indexOf(s)<0&&(f=fp(c),p=fp(l),u=f===p?parseFloat(c):Xh(n,s,c,p),d=parseFloat(l),e._pt=new zm(e._pt,o,s,u,d-u,_h),e._pt.u=p||0,e._props.push(s));yg(o,r)};Sf(`padding,margin,Width,Radius`,function(e,t){var n=`Top`,r=`Right`,i=`Bottom`,a=`Left`,o=(t<3?[n,r,i,a]:[n+a,n+r,i+r,i+a]).map(function(n){return t<2?e+n:`border`+n+e});ng[t>1?`border`+e:e]=function(e,t,n,r,i){var a,s;if(arguments.length<4)return a=o.map(function(t){return Zh(e,t,n)}),s=a.join(` `),s.split(a[0]).length===5?a[0]:s;a=(r+``).split(` `),s={},o.forEach(function(e,t){return s[e]=a[t]=a[t]||a[(t-1)/2|0]}),e.init(t,s,i)}});var xg={name:`css`,register:Vh,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,i){var a=this._props,o=e.style,s=n.vars.startAt,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;for(m in rh||Vh(),this.styles=this.styles||Fh(e),C=this.styles.props,this.tween=n,t)if(m!==`autoRound`&&(l=t[m],!(mf[m]&&hm(m,t,n,r,e,i)))){if(f=typeof l,p=ng[m],f===`function`&&(l=l.call(n,r,e,i),f=typeof l),f===`string`&&~l.indexOf(`random(`)&&(l=Ap(l)),p)p(this,e,m,l,n)&&(S=1);else if(m.substr(0,2)===`--`)c=(getComputedStyle(e).getPropertyValue(m)+``).trim(),l+=``,Gp.lastIndex=0,Gp.test(c)||(h=fp(c),g=fp(l),g?h!==g&&(c=Xh(e,m,c,g)+g):h&&(l+=h)),this.add(o,`setProperty`,c,l,r,i,0,0,m),a.push(m),C.push(m,0,o[m]);else if(f!==`undefined`){if(s&&m in s?(c=typeof s[m]==`function`?s[m].call(n,r,e,i):s[m],kd(c)&&~c.indexOf(`random(`)&&(c=Ap(c)),fp(c+``)||c===`auto`||(c+=gd.units[m]||fp(Zh(e,m))||``),(c+``).charAt(1)===`=`&&(c=Zh(e,m))):c=Zh(e,m),d=parseFloat(c),_=f===`string`&&l.charAt(1)===`=`&&l.substr(0,2),_&&(l=l.substr(2)),u=parseFloat(l),m in gh&&(m===`autoAlpha`&&(d===1&&Zh(e,`visibility`)===`hidden`&&u&&(d=0),C.push(`visibility`,0,o.visibility),qh(this,o,`visibility`,d?`inherit`:`hidden`,u?`inherit`:`hidden`,!u)),m!==`scale`&&m!==`transform`&&(m=gh[m],~m.indexOf(`,`)&&(m=m.split(`,`)[0]))),v=m in ch,v){if(this.styles.save(m),w=l,f===`string`&&l.substring(0,6)===`var(--`){if(l=Rh(e,l.substring(4,l.indexOf(`)`))),l.substring(0,5)===`calc(`){var T=e.style.perspective;e.style.perspective=l,l=Rh(e,`perspective`),T?e.style.perspective=T:Kh(e,`perspective`)}u=parseFloat(l)}if(y||(b=e._gsap,b.renderTransform&&!t.parseTransform||lg(e,t.parseTransform),x=t.smoothOrigin!==!1&&b.smooth,y=this._pt=new zm(this._pt,o,Ah,0,1,b.renderTransform,b,0,-1),y.dep=1),m===`scale`)this._pt=new zm(this._pt,b,`scaleY`,b.scaleY,(_?Tf(b.scaleY,_+u):u)-b.scaleY||0,_h),this._pt.u=0,a.push(`scaleY`,m),m+=`X`;else if(m===`transformOrigin`){C.push(jh,0,o[jh]),l=eg(l),b.svg?cg(e,l,0,x,0,this):(g=parseFloat(l.split(` `)[2])||0,g!==b.zOrigin&&qh(this,b,`zOrigin`,b.zOrigin,g),qh(this,o,m,ug(c),ug(l)));continue}else if(m===`svgOrigin`){cg(e,l,1,x,0,this);continue}else if(m in ig){vg(this,b,m,d,_?Tf(d,_+l):l);continue}else if(m===`smoothOrigin`){qh(this,b,`smooth`,b.smooth,l);continue}else if(m===`force3D`){b[m]=l;continue}else if(m===`transform`){bg(this,l,e);continue}}else m in o||(m=Bh(m)||m);if(v||(u||u===0)&&(d||d===0)&&!hh.test(l)&&m in o)h=(c+``).substr((d+``).length),u||=0,g=fp(l)||(m in gd.units?gd.units[m]:h),h!==g&&(d=Xh(e,m,c,g)),this._pt=new zm(this._pt,v?b:o,m,d,(_?Tf(d,_+u):u)-d,!v&&(g===`px`||m===`zIndex`)&&t.autoRound!==!1?xh:_h),this._pt.u=g||0,v&&w!==l?(this._pt.b=c,this._pt.e=w,this._pt.r=bh):h!==g&&g!==`%`&&(this._pt.b=c,this._pt.r=yh);else if(m in o)Qh.call(this,e,m,c,_?_+l:l);else if(m in e)this.add(e,m,c||e[m],_?_+l:l,r,i);else if(m!==`parseTransform`){nf(m,l);continue}v||(m in o?C.push(m,0,o[m]):typeof e[m]==`function`?C.push(m,2,e[m]()):C.push(m,1,c||e[m])),a.push(m)}}S&&Rm(this)},render:function(e,t){if(t.tween._time||!oh())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Zh,aliases:gh,getSetter:function(e,t,n){var r=gh[t];return r&&r.indexOf(`,`)<0&&(t=r),t in ch&&t!==jh&&(e._gsap.x||Zh(e,`x`))?n&&ah===n?t===`scale`?Dh:Eh:(ah=n||{})&&(t===`scale`?Oh:kh):e.style&&!Md(e.style[t])?wh:~t.indexOf(`-`)?Th:Am(e,t)},core:{_removeProperty:Kh,_getMatrix:sg}};$m.utils.checkPrefix=Bh,$m.core.getStyleSaver=Fh,(function(e,t,n,r){var i=Sf(e+`,`+t+`,`+n,function(e){ch[e]=1});Sf(t,function(e){gd.units[e]=`deg`,ig[e]=1}),gh[i[13]]=e+`,`+t,Sf(r,function(e){var t=e.split(`:`);gh[t[1]]=i[t[0]]})})(`x,y,z,scale,scaleX,scaleY,xPercent,yPercent`,`rotation,rotationX,rotationY,skewX,skewY`,`transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective`,`0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY`),Sf(`x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective`,function(e){gd.units[e]=`px`}),$m.registerPlugin(xg);var Sg=$m.registerPlugin(xg)||$m;Sg.core.Tween;var Cg,wg,Tg,Eg,Dg,Og=!1,kg=0,Ag=new Go,jg={x:0,y:1,z:5},Mg={x:0,y:2,z:9};function Ng(e,t){Cg=new cu({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`}),Cg.setPixelRatio(Math.min(window.devicePixelRatio,2)),Cg.setSize(window.innerWidth,window.innerHeight),Cg.outputColorSpace=Be,Cg.toneMapping=4,Cg.toneMappingExposure=1.2,wg=new In,wg.background=new Y(920069),wg.fog=new Fn(920069,8,20),Tg=new po(45,window.innerWidth/window.innerHeight,.1,100),Tg.position.set(Mg.x,Mg.y,Mg.z),Tg.lookAt(0,.5,0),Pg(),Fg(t),window.addEventListener(`resize`,Vg),window.addEventListener(`scroll`,zg,{passive:!0}),Bg()}function Pg(){let e=new xo(16766112,.6);wg.add(e);let t=new bo(16772306,1.8);t.position.set(3,5,4),t.castShadow=!1,wg.add(t);let n=new bo(13162736,.4);n.position.set(-3,2,2),wg.add(n);let r=new bo(16769200,.5);r.position.set(0,3,-4),wg.add(r);let i=new ho(16765072,.8,15,Math.PI/6,.5);i.position.set(0,6,0),i.target.position.set(0,0,0),wg.add(i),wg.add(i.target)}function Fg(e){let t=new fu,n=new fd;n.setDecoderPath(`https://www.gstatic.com/draco/versioned/decoders/1.5.7/`),t.setDRACOLoader(n),t.load(`/SystemPrinting-live/take_away_coffee_cup_set.glb`,t=>{Eg=t.scene;let n=new Zn().setFromObject(Eg),r=n.getCenter(new G),i=n.getSize(new G);Eg.position.sub(r),Eg.position.y+=.3;let a=Math.max(i.x,i.y,i.z);if(a>3){let e=4/a;Eg.scale.setScalar(e)}Eg.traverse(e=>{e.isMesh&&(e.material.envMapIntensity=.8,e.material.metalness!==void 0&&(e.material.metalness=Math.min(e.material.metalness,.6)))}),wg.add(Eg),t.animations&&t.animations.length>0&&(Dg=new Wo(Eg),t.animations.forEach(e=>{Dg.clipAction(e).play()})),Ig(),e&&e(100)},t=>{e&&(t.total>0?e(Math.round(t.loaded/t.total*95)):e(Math.min(90,Math.round(t.loaded/16e6*95))))},t=>{console.error(`Error loading GLB:`,t),e&&e(100)})}function Ig(){let e=new gs(Cg);e.compileEquirectangularShader();let t=new In,n=new ni(new ua(10,32,32),new va({side:1,uniforms:{topColor:{value:new Y(1708040)},bottomColor:{value:new Y(920069)}},vertexShader:`
    ...
    `}));t.add(n);let r=e.fromScene(t,.04).texture;wg.environment=r,e.dispose()}function Lg(e){if(!Eg){let t=setInterval(()=>{Eg&&(clearInterval(t),Rg(e))},100);return}Rg(e)}function Rg(e){let t=Sg.timeline({onComplete:()=>{Og=!0,e&&e()}}),n={x:0,y:.5,z:0};t.to(Tg.position,{x:0,y:.8,z:3.8,duration:2,ease:`power2.inOut`,onUpdate:()=>Tg.lookAt(n.x,n.y,n.z)});let r={theta:0},i=3.8;t.to(r,{theta:Math.PI*1.6,duration:3,ease:`power1.inOut`,onUpdate:()=>{Tg.position.x=Math.sin(r.theta)*i,Tg.position.z=Math.cos(r.theta)*i,Tg.position.y=.6+Math.sin(r.theta*.5)*.3,Tg.lookAt(n.x,n.y,n.z)}}),t.to(Tg.position,{x:jg.x,y:jg.y,z:jg.z,duration:1.5,ease:`power2.inOut`,onUpdate:()=>Tg.lookAt(n.x,n.y,n.z)})}function zg(){let e=document.documentElement.scrollHeight-window.innerHeight;kg=e>0?window.scrollY/e:0}function Bg(){requestAnimationFrame(Bg);let e=Ag.getDelta();if(Dg&&Dg.update(e),Og&&Eg&&(Eg.rotation.y+=e*.15),Og){let e=jg.y-kg*.6;Tg.position.y+=(e-Tg.position.y)*.05,Tg.lookAt(0,.5-kg*.2,0)}Cg.render(wg,Tg)}function Vg(){Tg.aspect=window.innerWidth/window.innerHeight,Tg.updateProjectionMatrix(),Cg.setSize(window.innerWidth,window.innerHeight)}var Hg=document.getElementById(`bg`),Ug=document.getElementById(`loader`),Wg=document.querySelector(`.loader-fill`),Gg=document.getElementById(`overlay`),Kg=document.getElementById(`hamburger`),qg=document.getElementById(`navLinks`),Jg=document.querySelectorAll(`.filter-btn`),Yg=document.querySelectorAll(`.product-card`),Xg=document.getElementById(`contactForm`);Ng(Hg,Qg),e_(),t_(),n_(),r_();var Zg=!1;setTimeout(()=>{Zg||(console.warn(`Loading timeout — forcing proceed`),Qg(100))},12e3);function Qg(e){Wg&&(Wg.style.width=e+`%`),e>=100&&!Zg&&(Zg=!0,setTimeout(()=>{Lg($g),Ug.classList.add(`hidden`)},400))}function $g(){Gg.classList.add(`visible`),setTimeout(()=>{document.querySelectorAll(`#hero .hero-line, #hero .hero-sub, #hero .hero-actions`).forEach((e,t)=>{setTimeout(()=>{e.style.opacity=`1`,e.style.transform=`translateY(0)`},t*150)})},200)}function e_(){Kg.addEventListener(`click`,()=>{Kg.classList.toggle(`active`),qg.classList.toggle(`open`)}),qg.querySelectorAll(`a`).forEach(e=>{e.addEventListener(`click`,()=>{Kg.classList.remove(`active`),qg.classList.remove(`open`)})});let e=0,t=document.getElementById(`navbar`),n=document.getElementById(`hero`);window.addEventListener(`scroll`,()=>{let r=window.scrollY;r>e&&r>200?t.style.transform=`translateY(-100%)`:t.style.transform=`translateY(0)`,e=r;let i=n.offsetHeight,a=Math.min(r/i,1),o=1;a>.2&&(o=1-(a-.2)/.3),Hg.style.opacity=Math.max(0,Math.min(1,o))},{passive:!0})}function t_(){Jg.forEach(e=>{e.addEventListener(`click`,()=>{Jg.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.filter;Yg.forEach(e=>{t===`all`||e.dataset.category===t?e.classList.remove(`hidden`):e.classList.add(`hidden`)})})})}function n_(){let e=document.querySelectorAll(`.about-card, .product-card, .why-card, .section-header, .contact-form, .contact-info-card`);e.forEach(e=>e.classList.add(`reveal`));let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`active`),t.unobserve(e.target))})},{threshold:.1,rootMargin:`0px 0px -40px 0px`});e.forEach(e=>t.observe(e))}function r_(){Xg.addEventListener(`submit`,e=>{e.preventDefault();let t=new FormData(Xg),n=Object.fromEntries(t),r=Xg.querySelector(`button[type="submit"]`),i=r.textContent;r.textContent=`✓ Inquiry Sent!`,r.style.background=`#25D366`,r.disabled=!0,console.log(`Contact form submission:`,n),setTimeout(()=>{r.textContent=i,r.style.background=``,r.disabled=!1,Xg.reset()},3e3)})}